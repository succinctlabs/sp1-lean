...
Snapshot date: 2026-08-28, restamped for the plain-Sail headline flip atop `4048328d`.
The raw
per-declaration output is split by library — [`axiom-census.txt`](axiom-census.txt) (the main
`SP1Clean` library, 901 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 978 released declarations are probed (901 main + 77 test: the 34 real-row satisfiability
