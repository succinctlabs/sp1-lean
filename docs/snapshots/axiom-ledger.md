...
`SP1Clean` library, 917 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 994 released declarations are probed (917 main + 77 test: the 34 real-row satisfiability
  ...
  `supported_core_native_shard_execution_halted`) and the verifier's Exit pull
  (`sp1StateVerifierMain_exitInteractions`); the 2026-08-21 pair `stateBumpChip_faithful` /
