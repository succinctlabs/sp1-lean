...
`SP1Clean` library, 512 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 550 released declarations are probed (512 main + 38 test: the 34 real-row satisfiability
