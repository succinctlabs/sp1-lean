...
Snapshot date: 2026-08-25, restamped for the common Core-shard relation campaign atop `756e225e`.
The raw
...
battery, 72 declarations) — and is regenerated by
...
- 972 released declarations are probed (900 main + 72 test: the 34 real-row satisfiability
  ...
  invoke both AIR-witness and direct-ensemble conclusions.
...
- The common-shard change intentionally adds the declarations above and retires the intermediate
  ordinary-trace probes. Surviving declaration axiom sets remain stable; the new evaluator and Sail
  capstones inherit the already disclosed generated platform hooks, while the field, natural-ledger,
  and relational plumbing proofs add no new trust class. This remains the release gate for a
