...
`SP1Clean` library, 466 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
`SP1CleanTest` anchors: 34 real-row satisfiability + 3 independent-audit anchors,
37 declarations) — and is regenerated by
...
- 503 released declarations are probed (466 main + 37 test: the 34 real-row satisfiability
  anchors of `SP1CleanTest/NonVacuityReal.lean` and the two executable plus one definitional
  anchor of `SP1CleanTest/Audit/OneAddNativePremises.lean`; the 21 legacy `native_decide`
