...
`SP1Clean` library, 766 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
battery, 65 declarations) — and is regenerated by
...
- 831 released declarations are probed (766 main + 65 test: the 34 real-row satisfiability
