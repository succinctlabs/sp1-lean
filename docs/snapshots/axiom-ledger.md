...
`SP1Clean` library, 905 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 982 released declarations are probed (905 main + 77 test: the 34 real-row satisfiability
  ...
  shard's `HALT` ECALL (ensemble wiring follows separately).
