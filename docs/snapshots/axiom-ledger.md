...
Snapshot date: 2026-08-26, restamped for the active semantic/compiler non-vacuity audit atop
`d82b6322`.
The raw
per-declaration output is split by library — [`axiom-census.txt`](axiom-census.txt) (the main
`SP1Clean` library, 900 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 977 released declarations are probed (900 main + 77 test: the 34 real-row satisfiability
