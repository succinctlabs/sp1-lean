...
Snapshot date: 2026-08-29, restamped for the loaded boot witness atop `94a386e9`.
The raw
per-declaration output is split by library — [`axiom-census.txt`](axiom-census.txt) (the main
`SP1Clean` library, 907 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 984 released declarations are probed (907 main + 77 test: the 34 real-row satisfiability
