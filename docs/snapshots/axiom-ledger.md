...
`SP1CleanTest` anchors: 21 conformance + 34 real-row satisfiability + 3 independent-audit anchors,
58 declarations) — and is regenerated by
...
- 524 released declarations are probed (466 main + 58 test: the 21 conformance anchors, the
  34 real-row satisfiability anchors of `SP1CleanTest/NonVacuityReal.lean`, and the two executable
  plus one definitional anchor of `SP1CleanTest/Audit/OneAddNativePremises.lean`; the
