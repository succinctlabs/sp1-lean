...
`SP1Clean` library, 455 declarations) and [`axiom-census-test.txt`](axiom-census-test.txt) (the
...
- 510 released declarations are probed (455 main + 55 test: the 21 conformance anchors plus the
  34 real-row satisfiability anchors of `SP1CleanTest/NonVacuityReal.lean`, added 2026-08-08).
