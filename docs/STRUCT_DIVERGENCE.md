...
- ShiftLeft decomposition (open-question #4) — apply the same Phase 3e/3f pattern to map its 5 role-grouped intermediates to the upstream `c_bits` / `v_01,012,0123` / `lower_limb,higher_limb,limb_result` / `shift_u16` fields.
