...
lemma allHold_constraints_iff
  ...
  rw [h_borrow,
      ...
      carry_swap_iff d2 c2 hd2_swap,
      carry_swap_iff d3 c3 hd3_swap]
...
/-- Re-arranges each iff carry from inverse-form to a sum equation
...
theorem spec
  ...
  SP1ConstraintList.allHold (constraints a b cols 1) →
    cols.value.isU64 ∧
    cols.value.toBitVec64 = execute_RTYPE_pure_w a b .SUB := by
  intro cstrs
