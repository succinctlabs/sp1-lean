...
def constraints (I0 I1 I2 I3 I4 : BabyBear) :
    Vector BabyBear 4 × List (SP1Constraint) :=
  let E0 := I0 - I2
...
lemma toProp_constraintSet_iff_constraintProp
    (I0 I1 I2 I3 I4 : BabyBear) :
    List.Forall SP1Constraint.toProp (constraints I0 I1 I2 I3 I4).2 ↔
...
theorem spec_of_constraintSet
    (I0 I1 I2 I3 I4 : BabyBear)
    (h : List.Forall SP1Constraint.toProp (constraints I0 I1 I2 I3 I4).2) :
...
--     (h : List.Forall SP1Constraint.toProp (constraintSet I0 I1 I2 I3 I4)) :
