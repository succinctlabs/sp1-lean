...
@[irreducible] def constraints
  ...
  let E3 : Fin KB := 0 + cols.op_c
  let E4 : Fin KB := op_a_write_value[0] - 0
  let E5 : Fin KB := cols.op_a_0 * E4
  let E6 : Fin KB := op_a_write_value[1] - 0
  let E7 : Fin KB := cols.op_a_0 * E6
  let E8 : Fin KB := op_a_write_value[2] - 0
  let E9 : Fin KB := cols.op_a_0 * E8
  let E10 : Fin KB := op_a_write_value[3] - 0
  let E11 : Fin KB := cols.op_a_0 * E10
  let E12 : Fin KB := clk_low + 4
  let E13 : Fin KB := is_real - 1
  let E14 : Fin KB := is_real * E13
