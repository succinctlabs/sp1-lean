...
def constraints
  ...
  let E3 : Fin BB := cols.op_a_memory.prev_value[0] - 0
  let E4 : Fin BB := cols.op_a_0 * E3
  let E5 : Fin BB := cols.op_a_memory.prev_value[1] - 0
  let E6 : Fin BB := cols.op_a_0 * E5
  let E7 : Fin BB := cols.op_a_memory.prev_value[2] - 0
  let E8 : Fin BB := cols.op_a_0 * E7
  let E9 : Fin BB := cols.op_a_memory.prev_value[3] - 0
  ...
  [
    ...
    (.receive (.memory clk_high E11 cols.op_a 0 0 cols.op_a_memory.prev_value[0] cols.op_a_memory.prev_value[1] cols.op_a_memory.prev_value[2] cols.op_a_memory.prev_value[3]) is_real),
    (.assertZero E20),
