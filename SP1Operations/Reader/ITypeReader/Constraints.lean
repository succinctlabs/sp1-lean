...
@[irreducible] def constraints
  ...
  let E12 : Fin KB := op_a_write_value[0] - 0
  let E13 : Fin KB := cols.op_a_0 * E12
  let E14 : Fin KB := op_a_write_value[1] - 0
  let E15 : Fin KB := cols.op_a_0 * E14
  let E16 : Fin KB := op_a_write_value[2] - 0
  let E17 : Fin KB := cols.op_a_0 * E16
  let E18 : Fin KB := op_a_write_value[3] - 0
  ...
  [
    ...
    (.receive (.memory clk_high E20 cols.op_a 0 0 op_a_write_value[0] op_a_write_value[1] op_a_write_value[2] op_a_write_value[3]) is_real),
    (.assertZero E29),
