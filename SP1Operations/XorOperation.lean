...
def extractedConstraints (cols : XorOperation)
  ...
  {
  .sendAirInteraction_byte (.ofNat 2) cols.value[0] a[0] b[0] is_real,
  .sendAirInteraction_byte (.ofNat 2) cols.value[1] a[1] b[1] is_real,
  .sendAirInteraction_byte (.ofNat 2) cols.value[2] a[2] b[2] is_real,
  .sendAirInteraction_byte (.ofNat 2) cols.value[3] a[3] b[3] is_real
  }
