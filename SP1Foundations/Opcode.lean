...
def trusted_instr
  ...
  | LUI | AUIPC =>
      (imm_b = 1 ∧ imm_c = 1)
      ∧ op_c_0 >= 2^12
      ∧ BitVec.signExtend 64 (BitVec.ofNat 32 (op_c_0 + op_c_1 * 65536)) = Word.toBitVec64 #v[op_c_0, op_c_1, op_c_2, op_c_3]
  | JAL =>
      (op_b_0 < 32 ∧ op_b_1 = 0 ∧ op_b_2 = 0 ∧ op_b_3 = 0)
      -- 2^12 = 4096
      ∧ Word.toBitVec64 #v[op_c_0, op_c_1, op_c_2, op_c_3] = BitVec.signExtend 64 (BitVec.ofNat 21 (op_c_0 + op_c_1 * 65536))
  | LB | LH | LW | LD | LBU | LHU =>
      i_type_constraints op_a op_b_0 op_b_1 op_b_2 op_b_3 op_c_0 op_c_1 op_c_2 op_c_3 imm_b imm_c
  | SB | SH | SW | SD =>
      i_type_constraints op_a op_b_0 op_b_1 op_b_2 op_b_3 op_c_0 op_c_1 op_c_2 op_c_3 imm_b imm_c
