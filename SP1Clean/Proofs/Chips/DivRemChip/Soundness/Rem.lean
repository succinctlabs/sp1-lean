...
theorem soundness : GeneralFormalCircuit.Soundness (ZMod p) main Assumptions Spec := by
  ...
  · intro hr
    ...
    intro hflag
    have hflag : env.get (i₀ + 2) = 1 := hflag
    ...
    -- For REM (`e2 = 0`) the operands equal the raw reads (E20–E47), giving operand `isU64` and the read-lift.
    ...
    have hrem_id : Word.toBitVec64 (#v[env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4),
          env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 1),
          env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 2),
      ...
      · -- DIVZERO (`c = 0`): `quotient = -1`, `remainder = b` ⟹ `div_rem_divzero`.
        ...
        have hsem' : env.get (B + 7 + 8 + 8 + 11 + 11 + 10) = 1 := hsem
    ...
    have hb0 : env.get (i₀ + 8 + 4) = env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4) := by
      have h := e189; rw [hgateRem, one_mul] at h; linear_combination -h - e70
    have hb1 : env.get (i₀ + 8 + 4 + 1) = env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 1) := by
      have h := e199; rw [hgateRem, one_mul] at h; linear_combination -h - e71
    have hb2 : env.get (i₀ + 8 + 4 + 2) = env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 2) := by
      have h := e209; rw [hgateRem, one_mul] at h
      have h81' := e81; rw [hgateD, one_mul] at h81'
      linear_combination -h - h81'
    have hb3 : env.get (i₀ + 8 + 4 + 3) = env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 3) := by
    ...
    have haqc : (Vector.map (Expression.eval env)
        ...
        = #v[env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4),
          env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 1),
          env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 2),
          env.get (i₀ + 8 + 4 + 4 + 4 + 4 + 45 + 45 + 7 + 8 + 8 + 11 + 11 + 11 + 4 + 4 + 3)] := by
      apply Vector.ext; intro i hi
      interval_cases i <;> simp only [circuit_norm, Nat.add_zero, Vector.getElem_mk,
        List.getElem_toArray, List.getElem_cons_zero, List.getElem_cons_succ]
      exacts [hb0, hb1, hb2, hb3]
    rw [hbeq, hceq] at hrem_id
