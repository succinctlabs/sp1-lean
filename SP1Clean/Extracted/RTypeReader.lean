...
@[irreducible] def interactions {F : Type} [Field F] [CoeHead F ℕ]
  ...
  [
    ...
    ⟨.send, (.byte 6 cols.op_c_memory.access_timestamp.diff_low_limb 16 0), is_real⟩,
    ⟨.send, (.byte 3 0 E32 0), is_real⟩,
