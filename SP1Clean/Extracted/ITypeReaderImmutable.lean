...
(`--operation ITypeReaderImmutable --format lean`). Contains SP1's `ITypeReaderImmutable` operation
constraints (reusing the RTypeReader, ITypeReader column-struct module(s), imported above). Regenerate
