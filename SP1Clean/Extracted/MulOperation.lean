...
(`--operation MulOperation --format lean`). Contains SP1's `MulOperation` operation
constraints (reusing the U16toU8OperationUnsafe, U16MSBOperation, U16toU8OperationSafe column-struct module(s), imported above). Regenerate
