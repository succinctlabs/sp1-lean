...
/-- Type quantifiers: k_ex69502# : Bool, width : Nat, width ∈ {1, 2, 4, 8} -/
def valid_load_encdec (width : Nat) (is_unsigned : Bool) : Bool :=
  ((width <b xlen_bytes) || ((not is_unsigned) && (width ≤b xlen_bytes)))

/-- Type quantifiers: k_ex69505# : Bool, k_n : Nat, 0 < k_n ∧ k_n ≤ xlen -/
...
/-- Type quantifiers: k_ex69506# : Bool -/
...
/-- Type quantifiers: k_ex69507# : Bool -/
