...
def mem_write_callback (x_0 : String) (x_1 : (BitVec (if 64 = 32 then 34 else 64))) (x_2 : Nat) (x_3 : (BitVec (8 * x_2))) : Unit :=
  ()

/-- Type quantifiers: x_2 : Nat, 0 < x_2 ∧ x_2 ≤ max_mem_access -/
def mem_read_callback (x_0 : String) (x_1 : (BitVec (if 64 = 32 then 34 else 64))) (x_2 : Nat) (x_3 : (BitVec (8 * x_2))) : Unit :=
  ()

/-- Type quantifiers: x_1 : Nat, 0 ≤ x_1 ∧ x_1 < xlen -/
def mem_exception_callback (x_0 : (BitVec (if 64 = 32 then 34 else 64))) (x_1 : Nat) : Unit :=
  ()
