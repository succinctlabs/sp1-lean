...
variable (Main : Vector (Fin BB) 70)
...
@[irreducible] def constraints (Main : Vector (Fin BB) 70) : SP1ConstraintList :=
  ...
  let E3 : Fin BB := Main[65] - 1
  let E4 : Fin BB := Main[65] * E3
  let E5 : Fin BB := Main[66] - 1
  let E6 : Fin BB := Main[66] * E5
  let E7 : Fin BB := Main[67] - 1
  let E8 : Fin BB := Main[67] * E7
  let E9 : Fin BB := Main[68] - 1
  let E10 : Fin BB := Main[68] * E9
  let E11 : Fin BB := E2 - 1
  let E12 : Fin BB := E2 * E11
  let E13 : Fin BB := Main[67] + Main[68]
  let E14 : Fin BB := Main[65] + Main[66]
  let E15 : Fin BB := Main[65] * 7
  let E16 : Fin BB := Main[66] * 8
  let E17 : Fin BB := E15 + E16
  let E18 : Fin BB := Main[67] * 42
  let E19 : Fin BB := E17 + E18
  let E20 : Fin BB := Main[68] * 43
  let E21 : Fin BB := E19 + E20
  let E22 : Fin BB := Main[65] * 5
  let E23 : Fin BB := Main[66] * 5
  let E24 : Fin BB := E22 + E23
  let E25 : Fin BB := Main[67] * 5
  let E26 : Fin BB := E24 + E25
  let E27 : Fin BB := Main[68] * 5
  let E28 : Fin BB := E26 + E27
  let E29 : Fin BB := Main[65] * 0
  let E30 : Fin BB := Main[66] * 32
  let E31 : Fin BB := E29 + E30
  let E32 : Fin BB := Main[67] * 0
  let E33 : Fin BB := E31 + E32
  let E34 : Fin BB := Main[68] * 32
  let E35 : Fin BB := E33 + E34
  let E36 : Fin BB := Main[65] * 51
  let E37 : Fin BB := Main[66] * 51
  let E38 : Fin BB := E36 + E37
  let E39 : Fin BB := Main[67] * 59
  let E40 : Fin BB := E38 + E39
  let E41 : Fin BB := Main[68] * 59
  let E42 : Fin BB := E40 + E41
  let E43 : Fin BB := 32 * Main[31]
  let E44 : Fin BB := E42 - E43
  let E45 : Fin BB := Main[67] + Main[68]
  let E46 : Fin BB := E45 * Main[31]
  let E47 : Fin BB := Main[69] - E46
  let E48 : Fin BB := Main[65] * 8
  let E49 : Fin BB := Main[66] * 8
  let E50 : Fin BB := E48 + E49
  let E51 : Fin BB := Main[67] * 8
  let E52 : Fin BB := E50 + E51
  let E53 : Fin BB := Main[68] * 8
  let E54 : Fin BB := E52 + E53
  let E55 : Fin BB := 6 * Main[31]
  let E56 : Fin BB := 1 * Main[69]
  let E57 : Fin BB := E55 + E56
  let E58 : Fin BB := E54 - E57
  let E59 : Fin BB := Main[39] - 1
  let E60 : Fin BB := Main[39] * E59
  let E61 : Fin BB := Main[40] - 1
  let E62 : Fin BB := Main[40] * E61
  let E63 : Fin BB := Main[41] - 1
  let E64 : Fin BB := Main[41] * E63
  let E65 : Fin BB := Main[42] - 1
  let E66 : Fin BB := Main[42] * E65
  let E67 : Fin BB := Main[43] - 1
  let E68 : Fin BB := Main[43] * E67
  let E69 : Fin BB := Main[44] - 1
  let E70 : Fin BB := Main[44] * E69
  let E71 : Fin BB := Main[39] * 1
  let E72 : Fin BB := 0 + E71
  let E73 : Fin BB := Main[40] * 2
  let E74 : Fin BB := E72 + E73
  let E75 : Fin BB := Main[41] * 4
  let E76 : Fin BB := E74 + E75
  let E77 : Fin BB := Main[42] * 8
  let E78 : Fin BB := E76 + E77
  let E79 : Fin BB := Main[43] * 16
  let E80 : Fin BB := E78 + E79
  let E81 : Fin BB := Main[44] * 32
  let E82 : Fin BB := E80 + E81
  let E83 : Fin BB := Main[25] - E82
  let E84 : Fin BB := E83 * 2097414145
  let E85 : Fin BB := Main[44] * 2
  let E86 : Fin BB := E85 * E14
  let E87 : Fin BB := Main[43] + E86
  let E88 : Fin BB := E87 - 0
  let E89 : Fin BB := Main[61] * E88
  let E90 : Fin BB := Main[61] - 1
  let E91 : Fin BB := Main[61] * E90
  let E92 : Fin BB := Main[44] * 2
  let E93 : Fin BB := E92 * E14
  let E94 : Fin BB := Main[43] + E93
  let E95 : Fin BB := E94 - 1
  let E96 : Fin BB := Main[62] * E95
  let E97 : Fin BB := Main[62] - 1
  let E98 : Fin BB := Main[62] * E97
  let E99 : Fin BB := Main[44] * 2
  let E100 : Fin BB := E99 * E14
  let E101 : Fin BB := Main[43] + E100
  let E102 : Fin BB := E101 - 2
  let E103 : Fin BB := Main[63] * E102
  let E104 : Fin BB := Main[63] - 1
  let E105 : Fin BB := Main[63] * E104
  let E106 : Fin BB := Main[44] * 2
  let E107 : Fin BB := E106 * E14
  let E108 : Fin BB := Main[43] + E107
  let E109 : Fin BB := E108 - 3
  let E110 : Fin BB := Main[64] * E109
  let E111 : Fin BB := Main[64] - 1
  let E112 : Fin BB := Main[64] * E111
  let E113 : Fin BB := Main[61] + Main[62]
  let E114 : Fin BB := E113 + Main[63]
  let E115 : Fin BB := E114 + Main[64]
  let E116 : Fin BB := E115 - 1
  let E117 : Fin BB := E2 * E116
  let E118 : Fin BB := 1 - Main[39]
  let E119 : Fin BB := E118 + 1
  let E120 : Fin BB := E119 * 2
  let E121 : Fin BB := 1 - Main[40]
  let E122 : Fin BB := E121 * 3
  let E123 : Fin BB := E122 + 1
  let E124 : Fin BB := E120 * E123
  let E125 : Fin BB := Main[48] - E124
  let E126 : Fin BB := 1 - Main[41]
  let E127 : Fin BB := E126 * 15
  let E128 : Fin BB := E127 + 1
  let E129 : Fin BB := Main[48] * E128
  let E130 : Fin BB := Main[47] - E129
  let E131 : Fin BB := 1 - Main[42]
  let E132 : Fin BB := E131 * 255
  let E133 : Fin BB := E132 + 1
  let E134 : Fin BB := Main[47] * E133
  let E135 : Fin BB := Main[46] - E134
  let E136 : Fin BB := 16 - E78
  let E137 : Fin BB := Main[15] * Main[46]
  let E138 : Fin BB := Main[53] * 65536
  let E139 : Fin BB := Main[49] * Main[46]
  let E140 : Fin BB := E138 + E139
  let E141 : Fin BB := E137 - E140
  let E142 : Fin BB := 16 - E78
  let E143 : Fin BB := Main[16] * Main[46]
  let E144 : Fin BB := Main[54] * 65536
  let E145 : Fin BB := Main[50] * Main[46]
  let E146 : Fin BB := E144 + E145
  let E147 : Fin BB := E143 - E146
  let E148 : Fin BB := 16 - E78
  let E149 : Fin BB := Main[17] * Main[46]
  let E150 : Fin BB := E149 * E14
  let E151 : Fin BB := Main[55] * 65536
  let E152 : Fin BB := Main[51] * Main[46]
  let E153 : Fin BB := E151 + E152
  let E154 : Fin BB := E150 - E153
  let E155 : Fin BB := 16 - E78
  let E156 : Fin BB := Main[18] * Main[46]
  let E157 : Fin BB := E156 * E14
  let E158 : Fin BB := Main[56] * 65536
  let E159 : Fin BB := Main[52] * Main[46]
  let E160 : Fin BB := E158 + E159
  let E161 : Fin BB := E157 - E160
  let E162 : Fin BB := Main[50] * Main[46]
  let E163 : Fin BB := Main[53] + E162
  let E164 : Fin BB := Main[57] - E163
  let E165 : Fin BB := Main[51] * Main[46]
  let E166 : Fin BB := Main[54] + E165
  let E167 : Fin BB := Main[58] - E166
  let E168 : Fin BB := Main[52] * Main[46]
  let E169 : Fin BB := Main[55] + E168
  let E170 : Fin BB := Main[59] - E169
  let E171 : Fin BB := Main[60] - Main[56]
  ...
  let E172 : Fin BB := Main[65] + Main[67]
  let E173 : Fin BB := E172 * Main[37]
  let E174 : Fin BB := Main[37] * Main[46]
  let E175 : Fin BB := Main[45] - E174
  let CS2 : SP1ConstraintList := U16MSBOperation.constraints Main[34] { msb := Main[38] } E13
  let E176 : Fin BB := E13 - 1
  let E177 : Fin BB := E176 * Main[38]
  let E178 : Fin BB := Main[33] - Main[57]
  let E179 : Fin BB := Main[61] * E178
  let E180 : Fin BB := E14 * E179
  let E181 : Fin BB := Main[34] - Main[58]
  let E182 : Fin BB := Main[61] * E181
  let E183 : Fin BB := E14 * E182
  let E184 : Fin BB := Main[35] - Main[59]
  let E185 : Fin BB := Main[61] * E184
  let E186 : Fin BB := E14 * E185
  let E187 : Fin BB := Main[37] * 65536
  let E188 : Fin BB := E187 - Main[45]
  let E189 : Fin BB := Main[60] + E188
  let E190 : Fin BB := Main[36] - E189
  let E191 : Fin BB := Main[61] * E190
  let E192 : Fin BB := E14 * E191
  let E193 : Fin BB := Main[33] - Main[58]
  let E194 : Fin BB := Main[62] * E193
  let E195 : Fin BB := E14 * E194
  let E196 : Fin BB := Main[34] - Main[59]
  let E197 : Fin BB := Main[62] * E196
  let E198 : Fin BB := E14 * E197
  let E199 : Fin BB := Main[37] * 65536
  let E200 : Fin BB := E199 - Main[45]
  let E201 : Fin BB := Main[60] + E200
  let E202 : Fin BB := Main[35] - E201
  let E203 : Fin BB := Main[62] * E202
  let E204 : Fin BB := E14 * E203
  let E205 : Fin BB := Main[37] * 65535
  let E206 : Fin BB := Main[36] - E205
  let E207 : Fin BB := Main[62] * E206
  let E208 : Fin BB := E14 * E207
  let E209 : Fin BB := Main[33] - Main[59]
  let E210 : Fin BB := Main[63] * E209
  let E211 : Fin BB := E14 * E210
  let E212 : Fin BB := Main[37] * 65536
  let E213 : Fin BB := E212 - Main[45]
  let E214 : Fin BB := Main[60] + E213
  let E215 : Fin BB := Main[34] - E214
  let E216 : Fin BB := Main[63] * E215
  let E217 : Fin BB := E14 * E216
  let E218 : Fin BB := Main[37] * 65535
  let E219 : Fin BB := Main[35] - E218
  let E220 : Fin BB := Main[63] * E219
  let E221 : Fin BB := E14 * E220
  let E222 : Fin BB := Main[37] * 65535
  let E223 : Fin BB := Main[36] - E222
  let E224 : Fin BB := Main[63] * E223
  let E225 : Fin BB := E14 * E224
  let E226 : Fin BB := Main[37] * 65536
  let E227 : Fin BB := E226 - Main[45]
  let E228 : Fin BB := Main[60] + E227
  let E229 : Fin BB := Main[33] - E228
  let E230 : Fin BB := Main[64] * E229
  let E231 : Fin BB := E14 * E230
  let E232 : Fin BB := Main[37] * 65535
  let E233 : Fin BB := Main[34] - E232
  let E234 : Fin BB := Main[64] * E233
  let E235 : Fin BB := E14 * E234
  let E236 : Fin BB := Main[37] * 65535
  let E237 : Fin BB := Main[35] - E236
  let E238 : Fin BB := Main[64] * E237
  let E239 : Fin BB := E14 * E238
  let E240 : Fin BB := Main[37] * 65535
  let E241 : Fin BB := Main[36] - E240
  let E242 : Fin BB := Main[64] * E241
  let E243 : Fin BB := E14 * E242
  let E244 : Fin BB := Main[33] - Main[57]
  let E245 : Fin BB := Main[61] * E244
  let E246 : Fin BB := E13 * E245
  let E247 : Fin BB := Main[37] * 65536
  let E248 : Fin BB := E247 - Main[45]
  let E249 : Fin BB := Main[58] + E248
  let E250 : Fin BB := Main[34] - E249
  let E251 : Fin BB := Main[61] * E250
  let E252 : Fin BB := E13 * E251
  let E253 : Fin BB := Main[37] * 65536
  let E254 : Fin BB := E253 - Main[45]
  let E255 : Fin BB := Main[58] + E254
  let E256 : Fin BB := Main[33] - E255
  let E257 : Fin BB := Main[62] * E256
  let E258 : Fin BB := E13 * E257
  let E259 : Fin BB := Main[37] * 65535
  let E260 : Fin BB := Main[34] - E259
  let E261 : Fin BB := Main[62] * E260
  let E262 : Fin BB := E13 * E261
  let E263 : Fin BB := Main[38] * 65535
  let E264 : Fin BB := Main[35] - E263
  let E265 : Fin BB := E13 * E264
  let E266 : Fin BB := Main[38] * 65535
  let E267 : Fin BB := Main[36] - E266
  let E268 : Fin BB := E13 * E267
  let E269 : Fin BB := Main[3] + 4
  ...
  let E270 : Fin BB := Main[1] * 65536
  let E271 : Fin BB := Main[2] + E270
...
lemma is_mod_64 {c0 m : Fin BB} : m < 64 → c0 < 65536 → ((c0 - m) * 2097414145).val < 1024 → c0.val % 64 = m := by
