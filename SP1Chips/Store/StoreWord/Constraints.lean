...
@[irreducible] def constraints (Main : Vector (Fin KB) 46) : SP1ConstraintList :=
  ...
  let E30 : Fin KB := mprotect_enabled () * Main[44]
  let E31 : Fin KB := Main[45] - E30
  let E32 : Fin KB := E1 + 1
  let E33 : Fin KB := Main[7] - Main[30]
  let E34 : Fin KB := 1 - Main[39]
  let E35 : Fin KB := E33 * E34
  let E36 : Fin KB := Main[30] + E35
  let E37 : Fin KB := Main[40] - E36
  let E38 : Fin KB := Main[8] - Main[31]
  let E39 : Fin KB := 1 - Main[39]
  let E40 : Fin KB := E38 * E39
  let E41 : Fin KB := Main[31] + E40
  let E42 : Fin KB := Main[41] - E41
  let E43 : Fin KB := Main[7] - Main[32]
  let E44 : Fin KB := E43 * Main[39]
  let E45 : Fin KB := Main[32] + E44
  let E46 : Fin KB := Main[42] - E45
  let E47 : Fin KB := Main[8] - Main[33]
  let E48 : Fin KB := E47 * Main[39]
  let E49 : Fin KB := Main[33] + E48
  let E50 : Fin KB := Main[43] - E49
  let E51 : Fin KB := Main[3] + 4
