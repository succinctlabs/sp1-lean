...
lemma allHold_constraints_iff_of_is_real (Main : Vector (ZMod p) 44)
  ...
  List.Forall SP1Constraint.toProp (constraints Main) ↔
    ...
    Main[39] = Main[29] + (Main[7] - Main[29]) * (1 - Main[38]) ∧
    Main[40] = Main[30] + (Main[8] - Main[30]) * (1 - Main[38]) ∧
    Main[41] = Main[31] + (Main[7] - Main[31]) * Main[38] ∧
    Main[42] = Main[32] + (Main[8] - Main[32]) * Main[38]) := by
  have : Main[43] = 1 := h_is_real
