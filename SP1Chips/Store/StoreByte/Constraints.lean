...
@[irreducible] def constraints (Main : Vector (Fin KB) 52) : SP1ConstraintList :=
  let E0 : Fin KB := Main[1] * 65536
  let E1 : Fin KB := Main[2] + E0
  let E2 : Fin KB := Main[50] - 1
  let E3 : Fin KB := Main[50] * E2
  ...
  let E29 : Fin KB := Main[50] * E28
  let E30 : Fin KB := public_value () 151 * Main[50]
  let E31 : Fin KB := Main[51] - E30
  let E32 : Fin KB := E1 + 1
  let E33 : Fin KB := Main[40] - 1
  let E34 : Fin KB := Main[41] - 1
  let E35 : Fin KB := Main[42] - Main[30]
  let E36 : Fin KB := E34 * E35
  let E37 : Fin KB := E33 * E36
  let E38 : Fin KB := Main[41] - 1
  let E39 : Fin KB := Main[42] - Main[31]
  let E40 : Fin KB := E38 * E39
  let E41 : Fin KB := Main[40] * E40
  let E42 : Fin KB := Main[40] - 1
  let E43 : Fin KB := Main[42] - Main[32]
  let E44 : Fin KB := Main[41] * E43
  let E45 : Fin KB := E42 * E44
  let E46 : Fin KB := Main[42] - Main[33]
  let E47 : Fin KB := Main[41] * E46
  let E48 : Fin KB := Main[40] * E47
  let E49 : Fin KB := Main[7] - Main[44]
  let E50 : Fin KB := E49 * 2122383361
  let E51 : Fin KB := Main[42] - Main[43]
  let E52 : Fin KB := E51 * 2122383361
  let E53 : Fin KB := Main[44] - Main[43]
  let E54 : Fin KB := 1 - Main[39]
  let E55 : Fin KB := E53 * E54
  let E56 : Fin KB := Main[44] - E52
  let E57 : Fin KB := 256 * E56
  let E58 : Fin KB := E57 * Main[39]
  let E59 : Fin KB := E55 + E58
  let E60 : Fin KB := Main[45] - E59
  let E61 : Fin KB := 1 - Main[40]
  let E62 : Fin KB := Main[45] * E61
  let E63 : Fin KB := 1 - Main[41]
  let E64 : Fin KB := E62 * E63
  let E65 : Fin KB := E64 + Main[30]
  let E66 : Fin KB := Main[46] - E65
  let E67 : Fin KB := Main[45] * Main[40]
  let E68 : Fin KB := 1 - Main[41]
  let E69 : Fin KB := E67 * E68
  let E70 : Fin KB := E69 + Main[31]
  let E71 : Fin KB := Main[47] - E70
  let E72 : Fin KB := 1 - Main[40]
  let E73 : Fin KB := Main[45] * E72
  let E74 : Fin KB := E73 * Main[41]
  let E75 : Fin KB := E74 + Main[32]
  let E76 : Fin KB := Main[48] - E75
  let E77 : Fin KB := Main[45] * Main[40]
  let E78 : Fin KB := E77 * Main[41]
  let E79 : Fin KB := E78 + Main[33]
  let E80 : Fin KB := Main[49] - E79
  let E81 : Fin KB := Main[3] + 4
