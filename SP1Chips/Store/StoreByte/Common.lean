...
lemma allHold_constraints_iff_of_is_real (Main : Vector (ZMod p) 50)
  ...
  List.Forall SP1Constraint.toProp (constraints Main) ↔
    ...
    ((0 : ZMod p) < 256 ∧ Main[43] < (256 : ZMod p) ∧
      (Main[7] - Main[43]) * (256 : ZMod p)⁻¹ < (256 : ZMod p)) ∧
    ((0 : ZMod p) < 256 ∧ Main[42] < (256 : ZMod p) ∧
      (Main[41] - Main[42]) * (256 : ZMod p)⁻¹ < (256 : ZMod p)) ∧
    Main[44] = (Main[43] - Main[42]) * (1 - Main[38]) +
      256 * (Main[43] - (Main[41] - Main[42]) * (256 : ZMod p)⁻¹) * Main[38] ∧
    Main[45] = Main[44] * (1 - Main[39]) * (1 - Main[40]) + Main[29] ∧
    Main[46] = Main[44] * Main[39] * (1 - Main[40]) + Main[30] ∧
    Main[47] = Main[44] * (1 - Main[39]) * Main[40] + Main[31] ∧
    Main[48] = Main[44] * Main[39] * Main[40] + Main[32]) := by
  have : Main[49] = 1 := h_is_real
