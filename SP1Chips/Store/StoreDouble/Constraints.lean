...
-- Generated Lean code for chip StoreDoubleChip
@[irreducible] def constraints (Main : Vector (Fin BB) 41) : SP1ConstraintList :=
  ...
  CS0 ++ CS1 ++ CS2 ++ [
    ...
    (.receive (.memory Main[0] E7 E4 E5 E6 Main[7] Main[8] Main[9] Main[10]) Main[39]),
    (.assertZero E31),
  ]
