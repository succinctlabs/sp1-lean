...
def constraints (Main : Vector (Fin BB) 39) : SP1ConstraintList :=
  ...
  CS0 ++ CS1 ++ CS2 ++ [
    ...
    (.receive (.memory Main[0]$ E1 E4 E5 E6 Main[7]$ Main[8]$ Main[9]$ Main[10]$) Main[38]$),
  ]
