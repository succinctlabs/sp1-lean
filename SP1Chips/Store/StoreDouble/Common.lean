...
lemma allHold_constraints_iff_of_is_real (Main : Vector (ZMod p) 39)
  ...
  List.Forall SP1Constraint.toProp (constraints Main) ↔
    ...
    Word.isU64 #v[Main[29], Main[30], Main[31], Main[32]]) := by
  have : Main[38] = 1 := h_is_real
