...
@[irreducible] def constraints (Main : Vector (Fin KB) 32) : SP1ConstraintList :=
  ...
  let E4 : Fin KB := Main[30] * 35
  let E5 : Fin KB := 1 - Main[30]
  let E6 : Fin KB := E5 * 36
  let E7 : Fin KB := E4 + E6
  let E8 : Fin KB := 1 - Main[30]
  let E9 : Fin KB := Main[30] * 0
  let E10 : Fin KB := E8 * 0
  let E11 : Fin KB := E9 + E10
  let E12 : Fin KB := Main[30] * 0
  let E13 : Fin KB := E8 * 0
  let E14 : Fin KB := E12 + E13
  let E15 : Fin KB := Main[30] * 23
  let E16 : Fin KB := E8 * 55
  let E17 : Fin KB := E15 + E16
  let E18 : Fin KB := Main[30] * 128
  ...
  let E22 : Fin KB := Main[30] * Main[3]
  let E23 : Fin KB := 1 - Main[30]
  let E24 : Fin KB := E23 * 0
  let E25 : Fin KB := E22 + E24
  let E26 : Fin KB := Main[30] * Main[4]
  let E27 : Fin KB := 1 - Main[30]
  let E28 : Fin KB := E27 * 0
  let E29 : Fin KB := E26 + E28
  let E30 : Fin KB := Main[30] * Main[5]
  let E31 : Fin KB := 1 - Main[30]
  let E32 : Fin KB := E31 * 0
  let E33 : Fin KB := E30 + E32
  let E34 : Fin KB := Main[30] * 0
  let E35 : Fin KB := 1 - Main[30]
  let E36 : Fin KB := E35 * 0
  let E37 : Fin KB := E34 + E36
  let E38 : Fin KB := Main[23] - E25
  let E39 : Fin KB := Main[24] - E29
  let E40 : Fin KB := Main[25] - E33
  let E41 : Fin KB := 0 - E37
  let E42 : Fin KB := Main[31] - 1
  let E43 : Fin KB := E42 * Main[13]
  let E44 : Fin KB := Main[31] - Main[13]
