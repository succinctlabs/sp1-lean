...
@[irreducible] def constraints (Main : Vector (Fin KB) 31) : SP1ConstraintList (Fin KB) :=
  ...
  let CS0 : SP1ConstraintList (Fin KB) := CPUState.constraints { clk_high := Main[0], clk_16_24 := Main[1], clk_0_16 := Main[2], pc := #v[Main[3], Main[4], Main[5]] } #v[E21, Main[4], Main[5]] 8 Main[30]
  ...
  let CS1 : SP1ConstraintList (Fin KB) := AddOperation.constraints #v[Main[22], Main[23], Main[24], 0] #v[Main[14], Main[15], Main[16], Main[17]] { value := #v[Main[25], Main[26], Main[27], Main[28]] } E44
  let E45 : Fin KB := Main[1] * 65536
  let E46 : Fin KB := Main[2] + E45
  let CS2 : SP1ConstraintList (Fin KB) := JTypeReader.constraints Main[0] E46 #v[Main[3], Main[4], Main[5]] E7 #v[E20, E17, E11, E14] #v[Main[25], Main[26], Main[27], Main[28]] { op_a := Main[6], op_a_memory := { prev_value := #v[Main[7], Main[8], Main[9], Main[10]], access_timestamp := { prev_low := Main[11], diff_low_limb := Main[12] } }, op_a_0 := Main[13], op_b_imm := #v[Main[14], Main[15], Main[16], Main[17]], op_c_imm := #v[Main[18], Main[19], Main[20], Main[21]] } Main[30]
  CS0 ++ CS1 ++ CS2 ++ [
    (.assertZero E1),
    (.assertZero E3),
    (.assertZero E38),
