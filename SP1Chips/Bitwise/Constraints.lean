...
@[irreducible] def constraints (Main : Vector (Fin BB) 52) : SP1ConstraintList :=
  ...
  let E4 : Fin BB := Main[50] - 1
  let E5 : Fin BB := Main[50] * E4
  let E6 : Fin BB := Main[51] - 1
  let E7 : Fin BB := Main[51] * E6
  let E8 : Fin BB := E1 - 1
  let E9 : Fin BB := E1 * E8
  let E10 : Fin BB := Main[49] * 2
  let E11 : Fin BB := Main[50] * 1
  let E12 : Fin BB := E10 + E11
  let E13 : Fin BB := Main[51] * 0
  let E14 : Fin BB := E12 + E13
  let E15 : Fin BB := Main[49] * 3
  let E16 : Fin BB := Main[50] * 4
  let E17 : Fin BB := E15 + E16
  let E18 : Fin BB := Main[51] * 5
  let E19 : Fin BB := E17 + E18
  let E20 : Fin BB := Main[49] * 4
  let E21 : Fin BB := Main[50] * 6
  let E22 : Fin BB := E20 + E21
  let E23 : Fin BB := Main[51] * 7
  let E24 : Fin BB := E22 + E23
  let E25 : Fin BB := Main[49] * 0
  let E26 : Fin BB := Main[50] * 0
  let E27 : Fin BB := E25 + E26
  let E28 : Fin BB := Main[51] * 0
  let E29 : Fin BB := E27 + E28
  let E30 : Fin BB := Main[49] * 51
  let E31 : Fin BB := Main[50] * 51
  let E32 : Fin BB := E30 + E31
  let E33 : Fin BB := Main[51] * 51
  let E34 : Fin BB := E32 + E33
  let E35 : Fin BB := 32 * Main[31]
  let E36 : Fin BB := E34 - E35
  let E37 : Fin BB := Main[49] * 8
  let E38 : Fin BB := Main[50] * 8
  let E39 : Fin BB := E37 + E38
  let E40 : Fin BB := Main[51] * 8
  let E41 : Fin BB := E39 + E40
  let E42 : Fin BB := 4 * Main[31]
  ...
  let E49 : Fin BB := Main[1] * 65536
  let E50 : Fin BB := Main[2] + E49
