...
-- Pre-regen proof at commit 750a3e6:SP1Chips/StoreDoubleChip.lean -- correct
-- (not ported: constraint tree reshape requires rewalking the obtain chain;
-- see `git show 750a3e6:SP1Chips/StoreDoubleChip.lean` for the full pre-regen proof body)
