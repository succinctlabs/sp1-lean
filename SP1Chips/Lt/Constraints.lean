...
@[irreducible] def constraints (Main : Vector (Fin KB) 45) : SP1ConstraintList :=
  let E0 : Fin KB := Main[33] + Main[34]
  let E1 : Fin KB := Main[33] - 1
  let E2 : Fin KB := Main[33] * E1
  let E3 : Fin KB := Main[34] - 1
  let E4 : Fin KB := Main[34] * E3
  let E5 : Fin KB := E0 - 1
  let E6 : Fin KB := E0 * E5
  ...
  let E8 : Fin KB := Main[33] * 9
  let E9 : Fin KB := Main[34] * 10
  let E10 : Fin KB := E8 + E9
  let E11 : Fin KB := Main[33] * 2
  let E12 : Fin KB := Main[34] * 3
  let E13 : Fin KB := E11 + E12
  let E14 : Fin KB := Main[33] * 0
  let E15 : Fin KB := Main[34] * 0
  let E16 : Fin KB := E14 + E15
  let E17 : Fin KB := Main[33] * 51
  let E18 : Fin KB := Main[34] * 51
  let E19 : Fin KB := E17 + E18
  let E20 : Fin KB := 32 * Main[31]
  let E21 : Fin KB := E19 - E20
  let E22 : Fin KB := Main[33] * 8
  let E23 : Fin KB := Main[34] * 8
  let E24 : Fin KB := E22 + E23
  let E25 : Fin KB := 4 * Main[31]
  let E26 : Fin KB := E24 - E25
  let E27 : Fin KB := Main[1] * 65536
  let E28 : Fin KB := Main[2] + E27
  let E29 : Fin KB := 0 + Main[35]
...
@[simp] def is_slt (Main : Vector (Fin KB) 45) := Main[33] = 1 ∧ Main[31] = 0
@[simp] def is_sltu (Main : Vector (Fin KB) 45) := Main[34] = 1 ∧ Main[31] = 0
@[simp] def is_slti (Main : Vector (Fin KB) 45) := Main[33] = 1 ∧ Main[31] = 1
@[simp] def is_sltiu (Main : Vector (Fin KB) 45) := Main[34] = 1 ∧ Main[31] = 1
