...
def constraints (Main : Vector (Fin BB) 253) : SP1ConstraintList :=
  let E0 : Fin BB := Main[211] + Main[212]
  let E1 : Fin BB := E0 + Main[213]
  let E2 : Fin BB := E1 + Main[214]
  let E3 : Fin BB := Main[211] + Main[212]
  let E4 : Fin BB := 1 - E2
  let E5 : Fin BB := Main[251] * E4
  let E6 : Fin BB := Main[246] - E5
  let E7 : Fin BB := Main[207] + Main[209]
  let E8 : Fin BB := E7 + Main[211]
  let E9 : Fin BB := E8 + Main[212]
  let E10 : Fin BB := Main[239] * E9
  let E11 : Fin BB := E10 - Main[243]
  let E12 : Fin BB := Main[240] * E9
  let E13 : Fin BB := E12 - Main[247]
  let E14 : Fin BB := Main[241] * E9
  let E15 : Fin BB := E14 - Main[248]
  ...
  let E167 : Fin BB := Main[247] * 65535
  ...
  let E173 : Fin BB := Main[247] * 65535
  ...
  let E235 : Fin BB := Main[243] - 1
  let E236 : Fin BB := Main[247] * E235
  let E237 : Fin BB := 1 - Main[247]
  let E238 : Fin BB := E237 * Main[243]
  let E239 : Fin BB := E234 * E238
  let CS6 : SP1ConstraintList := IsZeroWordOperation.constraints #v[Main[25], Main[26], Main[27], Main[28]] { is_zero_limb := #v[{ inverse := Main[196], result := Main[197] }, { inverse := Main[198], result := Main[199] }, { inverse := Main[200], result := Main[201] }, { inverse := Main[202], result := Main[203] }], is_zero_first_half := Main[204], is_zero_second_half := Main[205], result := Main[206] } Main[251]
  ...
  let E248 : Fin BB := Main[248] - 1
  let E249 : Fin BB := Main[40] - Main[64]
  let E250 : Fin BB := E248 * E249
  let E251 : Fin BB := Main[247] - 1
  let E252 : Fin BB := Main[52] - Main[60]
  let E253 : Fin BB := E251 * E252
  let E254 : Fin BB := Main[248] - 1
  let E255 : Fin BB := Main[41] - Main[65]
  let E256 : Fin BB := E254 * E255
  let E257 : Fin BB := Main[247] - 1
  let E258 : Fin BB := Main[53] - Main[61]
  let E259 : Fin BB := E257 * E258
  let E260 : Fin BB := Main[248] - 1
  let E261 : Fin BB := Main[42] - Main[66]
  let E262 : Fin BB := E260 * E261
  let E263 : Fin BB := Main[247] - 1
  let E264 : Fin BB := Main[54] - Main[62]
  let E265 : Fin BB := E263 * E264
  let E266 : Fin BB := Main[248] - 1
  let E267 : Fin BB := Main[43] - Main[67]
  let E268 : Fin BB := E266 * E267
  let E269 : Fin BB := Main[247] - 1
  let E270 : Fin BB := Main[55] - Main[63]
  let E271 : Fin BB := E269 * E270
  let CS7 : SP1ConstraintList := AddOperation.constraints #v[Main[40], Main[41], Main[42], Main[43]] #v[Main[64], Main[65], Main[66], Main[67]] { value := #v[Main[172], Main[173], Main[174], Main[175]] } Main[249]
  let E272 : Fin BB := 0 - Main[172]
  let E273 : Fin BB := Main[249] * E272
  let E274 : Fin BB := 0 - Main[173]
  let E275 : Fin BB := Main[249] * E274
  let E276 : Fin BB := 0 - Main[174]
  let E277 : Fin BB := Main[249] * E276
  let E278 : Fin BB := 0 - Main[175]
  let E279 : Fin BB := Main[249] * E278
  let CS8 : SP1ConstraintList := AddOperation.constraints #v[Main[56], Main[57], Main[58], Main[59]] #v[Main[60], Main[61], Main[62], Main[63]] { value := #v[Main[176], Main[177], Main[178], Main[179]] } Main[250]
  let E280 : Fin BB := 0 - Main[176]
  let E281 : Fin BB := Main[250] * E280
  let E282 : Fin BB := 0 - Main[177]
  let E283 : Fin BB := Main[250] * E282
  let E284 : Fin BB := 0 - Main[178]
  let E285 : Fin BB := Main[250] * E284
  let E286 : Fin BB := 0 - Main[179]
  let E287 : Fin BB := Main[250] * E286
  let E288 : Fin BB := Main[248] * Main[251]
  let E289 : Fin BB := Main[249] - E288
  let E290 : Fin BB := Main[247] * Main[251]
  let E291 : Fin BB := Main[250] - E290
  ...
  let E307 : Fin BB := E306 * Main[251]
  let E308 : Fin BB := E307 - Main[252]
  let CS9 : SP1ConstraintList := LtOperationUnsigned.constraints #v[Main[60], Main[61], Main[62], Main[63]] #v[Main[68], Main[69], Main[70], Main[71]] { u16_compare_operation := { bit := Main[180] }, u16_flags := #v[Main[181], Main[182], Main[183], Main[184]], not_eq_inv := Main[185], comparison_limbs := #v[Main[186], Main[187]] } Main[252]
  let E309 : Fin BB := 1 - Main[180]
  let E310 : Fin BB := Main[252] * E309
  let CS10 : SP1ConstraintList := U16MSBOperation.constraints Main[18] { msb := Main[239] } Main[246]
  let CS11 : SP1ConstraintList := U16MSBOperation.constraints Main[28] { msb := Main[241] } Main[246]
  let CS12 : SP1ConstraintList := U16MSBOperation.constraints Main[59] { msb := Main[240] } Main[246]
  let CS13 : SP1ConstraintList := U16MSBOperation.constraints Main[16] { msb := Main[239] } E2
  let CS14 : SP1ConstraintList := U16MSBOperation.constraints Main[26] { msb := Main[241] } E2
  let CS15 : SP1ConstraintList := U16MSBOperation.constraints Main[57] { msb := Main[240] } E2
  let CS16 : SP1ConstraintList := U16MSBOperation.constraints Main[45] { msb := Main[242] } E2
  ...
  let E343 : Fin BB := Main[216] - 1
  let E344 : Fin BB := Main[216] * E343
  let E345 : Fin BB := Main[246] - 1
  let E346 : Fin BB := Main[246] * E345
  let E347 : Fin BB := Main[243] - 1
  let E348 : Fin BB := Main[243] * E347
  let E349 : Fin BB := Main[244] - 1
  let E350 : Fin BB := Main[244] * E349
  let E351 : Fin BB := Main[245] - 1
  let E352 : Fin BB := Main[245] * E351
  let E353 : Fin BB := Main[247] - 1
  let E354 : Fin BB := Main[247] * E353
  let E355 : Fin BB := Main[248] - 1
  let E356 : Fin BB := Main[248] * E355
  let E357 : Fin BB := Main[251] - 1
  let E358 : Fin BB := Main[251] * E357
  let E359 : Fin BB := Main[249] - 1
  let E360 : Fin BB := Main[249] * E359
  let E361 : Fin BB := Main[250] - 1
  let E362 : Fin BB := Main[250] * E361
  ...
  let E386 : Fin BB := Main[208] * 5
  let E387 : Fin BB := Main[210] * 7
  let E388 : Fin BB := E386 + E387
  let E389 : Fin BB := Main[207] * 4
  let E390 : Fin BB := E388 + E389
  let E391 : Fin BB := Main[209] * 6
  let E392 : Fin BB := E390 + E391
  let E393 : Fin BB := Main[211] * 4
  let E394 : Fin BB := E392 + E393
  let E395 : Fin BB := Main[212] * 6
  let E396 : Fin BB := E394 + E395
  let E397 : Fin BB := Main[213] * 5
  let E398 : Fin BB := E396 + E397
  let E399 : Fin BB := Main[214] * 7
  let E400 : Fin BB := E398 + E399
  let E401 : Fin BB := Main[208] * 1
  let E402 : Fin BB := Main[210] * 1
  let E403 : Fin BB := E401 + E402
  let E404 : Fin BB := Main[207] * 1
  let E405 : Fin BB := E403 + E404
  let E406 : Fin BB := Main[209] * 1
  let E407 : Fin BB := E405 + E406
  let E408 : Fin BB := Main[211] * 1
  let E409 : Fin BB := E407 + E408
  let E410 : Fin BB := Main[212] * 1
  let E411 : Fin BB := E409 + E410
  let E412 : Fin BB := Main[213] * 1
  let E413 : Fin BB := E411 + E412
  let E414 : Fin BB := Main[214] * 1
  let E415 : Fin BB := E413 + E414
  let E416 : Fin BB := Main[3] + 4
  let CS17 : SP1ConstraintList := CPUState.constraints { clk_high := Main[0], clk_16_24 := Main[1], clk_0_16 := Main[2], pc := #v[Main[3], Main[4], Main[5]] } #v[E416, Main[4], Main[5]] 8 Main[251]
  let E417 : Fin BB := Main[1] * 65536
  let E418 : Fin BB := Main[2] + E417
  let CS18 : SP1ConstraintList := ALUTypeReader.constraints Main[0] E418 #v[Main[3], Main[4], Main[5]] E385 #v[Main[215], E400, E415] #v[Main[32], Main[33], Main[34], Main[35]] { op_a := Main[6], op_a_memory := { prev_value := #v[Main[7], Main[8], Main[9], Main[10]], access_timestamp := { prev_low := Main[11], diff_low_limb := Main[12] } }, op_a_0 := Main[13], op_b := Main[14], op_b_memory := { prev_value := #v[Main[15], Main[16], Main[17], Main[18]], access_timestamp := { prev_low := Main[19], diff_low_limb := Main[20] } }, op_c := #v[Main[21], Main[22], Main[23], Main[24]], op_c_memory := { prev_value := #v[Main[25], Main[26], Main[27], Main[28]], access_timestamp := { prev_low := Main[29], diff_low_limb := Main[30] } }, imm_c := Main[31] } Main[251]
  [
    (.assertZero E6),
    (.assertZero E11),
    (.assertZero E13),
    ...
    (.assertZero E308),
    (.assertZero E310),
    (.send (.byte (ByteOpcode.ofNat 6) Main[44] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[45] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[46] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[47] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[56] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[57] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[58] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[59] 16 0) Main[251]),
    (.assertZero E312),
    (.assertZero E314),
    (.assertZero E316),
    (.assertZero E318),
    ...
    (.assertZero E324),
    (.assertZero E326),
    (.send (.byte (ByteOpcode.ofNat 6) Main[72] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[73] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[74] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[75] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[76] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[77] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[78] 16 0) Main[251]),
    (.send (.byte (ByteOpcode.ofNat 6) Main[79] 16 0) Main[251]),
    (.assertZero E328),
    (.assertZero E330),
    (.assertZero E332),
    (.assertZero E334),
