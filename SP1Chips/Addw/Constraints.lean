...
def constraints (Main : Vector (Fin BB) 37) : SP1ConstraintList :=
  let E0 : Fin BB := Main[36] - 1
  let E1 : Fin BB := Main[36] * E0
  let E2 : Fin BB := 4 * Main[31]
  let E3 : Fin BB := 8 - E2
  let E4 : Fin BB := 32 * Main[31]
  let E5 : Fin BB := 59 - E4
  ...
  let E7 : Fin BB := Main[35] * 65535
  let E8 : Fin BB := Main[35] * 65535
  let E9 : Fin BB := Main[1] * 65536
  let E10 : Fin BB := Main[2] + E9
