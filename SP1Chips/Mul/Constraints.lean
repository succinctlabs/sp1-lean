...
lemma allHold_constraints_iff :
  List.Forall SP1Constraint.toProp (constraints Main) ↔
    List.Forall SP1Constraint.toProp (MulOperation.constraints #v[Main[32], Main[33], Main[34], Main[35]] #v[Main[15], Main[16], Main[17], Main[18]] #v[Main[25], Main[26], Main[27], Main[28]] { carry := #v[Main[36], Main[37], Main[38], Main[39], Main[40], Main[41], Main[42], Main[43], Main[44], Main[45], Main[46], Main[47], Main[48], Main[49], Main[50], Main[51]], product := #v[Main[52], Main[53], Main[54], Main[55], Main[56], Main[57], Main[58], Main[59], Main[60], Main[61], Main[62], Main[63], Main[64], Main[65], Main[66], Main[67]], b_lower_byte := { low_bytes := #v[Main[68], Main[69], Main[70], Main[71]] }, c_lower_byte := { low_bytes := #v[Main[72], Main[73], Main[74], Main[75]] }, b_msb := Main[76], c_msb := Main[77], product_msb := { msb := Main[78] }, b_sign_extend := Main[79], c_sign_extend := Main[80] } (Main[81] + Main[82] + Main[83] + Main[84] + Main[85]) Main[81] Main[82] Main[85] Main[83] Main[84]) ∧
    List.Forall SP1Constraint.toProp (CPUState.constraints { clk_high := Main[0], clk_16_24 := Main[1], clk_0_16 := Main[2], pc := #v[Main[3], Main[4], Main[5]] } #v[Main[3] + 4, Main[4], Main[5]] 8 (Main[81] + Main[82] + Main[83] + Main[84] + Main[85])) ∧
    List.Forall SP1Constraint.toProp (ALUTypeReader.constraints Main[0] (Main[2] + Main[1] * 65536) #v[Main[3], Main[4], Main[5]] (Main[81] * 11 + Main[82] * 12 + Main[83] * 13 + Main[84] * 14 + Main[85] * 47) #v[Main[86], (Main[81] * 0 + Main[82] * 1 + Main[83] * 3 + Main[84] * 2 + Main[85] * 0), (Main[81] * 1 + Main[82] * 1 + Main[83] * 1 + Main[84] * 1 + Main[85] * 1)] #v[Main[32], Main[33], Main[34], Main[35]] { op_a := Main[6], op_a_memory := { prev_value := #v[Main[7], Main[8], Main[9], Main[10]], access_timestamp := { prev_low := Main[11], diff_low_limb := Main[12] } }, op_a_0 := Main[13], op_b := Main[14], op_b_memory := { prev_value := #v[Main[15], Main[16], Main[17], Main[18]], access_timestamp := { prev_low := Main[19], diff_low_limb := Main[20] } }, op_c := #v[Main[21], Main[22], Main[23], Main[24]], op_c_memory := { prev_value := #v[Main[25], Main[26], Main[27], Main[28]], access_timestamp := { prev_low := Main[29], diff_low_limb := Main[30] } }, imm_c := Main[31] } (Main[81] + Main[82] + Main[83] + Main[84] + Main[85])) ∧
    (Main[81] = 0 ∨ Main[81] = 1) ∧
    (Main[82] = 0 ∨ Main[82] = 1) ∧
    (Main[83] = 0 ∨ Main[83] = 1) ∧
    (Main[85] = 0 ∨ Main[85] = 1) ∧
    (Main[84] = 0 ∨ Main[84] = 1) ∧
    (Main[81] + Main[82] + Main[83] + Main[84] + Main[85] = 0 ∨ Main[81] + Main[82] + Main[83] + Main[84] + Main[85] - 1 = 0) ∧
    (Main[81] + Main[82] + Main[83] + Main[84] + Main[85] = 0 ∨ Main[86] = (Main[31] * (Main[85] * 27) + (1 - Main[31]) * (Main[81] * 51 + Main[82] * 51 + Main[83] * 51 + Main[84] * 51 + Main[85] * 59)))
  := by
