...
@[irreducible] def constraints (Main : Vector (Fin KB) 82) : SP1ConstraintList :=
  let E0 : Fin KB := Main[76] + Main[77]
  let E1 : Fin KB := E0 + Main[78]
  let E2 : Fin KB := E1 + Main[79]
  let E3 : Fin KB := E2 + Main[80]
  let CS0 : SP1ConstraintList := MulOperation.constraints #v[Main[28], Main[28], Main[29], Main[30]] #v[Main[15], Main[16], Main[17], Main[18]] #v[Main[22], Main[23], Main[24], Main[25]] { carry := #v[Main[31], Main[32], Main[33], Main[34], Main[35], Main[36], Main[37], Main[38], Main[39], Main[40], Main[41], Main[42], Main[43], Main[44], Main[45], Main[46]], product := #v[Main[47], Main[48], Main[49], Main[50], Main[51], Main[52], Main[53], Main[54], Main[55], Main[56], Main[57], Main[58], Main[59], Main[60], Main[61], Main[62]], b_lower_byte := { low_bytes := #v[Main[63], Main[64], Main[65], Main[66]] }, c_lower_byte := { low_bytes := #v[Main[67], Main[68], Main[69], Main[70]] }, b_msb := Main[71], c_msb := Main[72], product_msb := { msb := Main[73] }, b_sign_extend := Main[74], c_sign_extend := Main[75] } E3 Main[76] Main[77] Main[80] Main[78] Main[79]
  let E4 : Fin KB := Main[76] - 1
  let E5 : Fin KB := Main[76] * E4
  let E6 : Fin KB := Main[77] - 1
  let E7 : Fin KB := Main[77] * E6
  let E8 : Fin KB := Main[78] - 1
  let E9 : Fin KB := Main[78] * E8
  let E10 : Fin KB := Main[80] - 1
  let E11 : Fin KB := Main[80] * E10
  let E12 : Fin KB := Main[79] - 1
  let E13 : Fin KB := Main[79] * E12
  let E14 : Fin KB := E3 - 1
  let E15 : Fin KB := E3 * E14
  let E16 : Fin KB := Main[76] * 11
  let E17 : Fin KB := Main[77] * 12
  let E18 : Fin KB := E16 + E17
  let E19 : Fin KB := Main[78] * 13
  let E20 : Fin KB := E18 + E19
  let E21 : Fin KB := Main[79] * 14
  let E22 : Fin KB := E20 + E21
  let E23 : Fin KB := Main[80] * 24
  let E24 : Fin KB := E22 + E23
  let E25 : Fin KB := Main[76] * 0
  let E26 : Fin KB := Main[77] * 1
  let E27 : Fin KB := E25 + E26
  let E28 : Fin KB := Main[78] * 3
  let E29 : Fin KB := E27 + E28
  let E30 : Fin KB := Main[79] * 2
  let E31 : Fin KB := E29 + E30
  let E32 : Fin KB := Main[80] * 0
  let E33 : Fin KB := E31 + E32
  let E34 : Fin KB := Main[76] * 1
  let E35 : Fin KB := Main[77] * 1
  let E36 : Fin KB := E34 + E35
  let E37 : Fin KB := Main[78] * 1
  let E38 : Fin KB := E36 + E37
  let E39 : Fin KB := Main[79] * 1
  let E40 : Fin KB := E38 + E39
  let E41 : Fin KB := Main[80] * 1
  let E42 : Fin KB := E40 + E41
  let E43 : Fin KB := Main[76] * 51
  let E44 : Fin KB := Main[77] * 51
  let E45 : Fin KB := E43 + E44
  let E46 : Fin KB := Main[78] * 51
  let E47 : Fin KB := E45 + E46
  let E48 : Fin KB := Main[79] * 51
  let E49 : Fin KB := E47 + E48
  let E50 : Fin KB := Main[80] * 59
  let E51 : Fin KB := E49 + E50
  let E52 : Fin KB := Main[76] * 8
  let E53 : Fin KB := Main[77] * 8
  let E54 : Fin KB := E52 + E53
  let E55 : Fin KB := Main[78] * 8
  let E56 : Fin KB := E54 + E55
  let E57 : Fin KB := Main[79] * 8
  let E58 : Fin KB := E56 + E57
  let E59 : Fin KB := Main[80] * 8
