...
theorem correct_blt
  ...
  := by
    ...
    simp [h_is_real, h_is_blt, h_28, h_29, h_31, h_32, h_33, Opcode.ofNat, Nat.ble, Nat.beq] at state_cstrs
    ...
    · rename_i h_lts
      ...
      simp [h_is_blt, h_neq, h_is_lt, h_is_neq, h_28, h_29, h_31, h_32, h_33, h_is_real, h_opcode, Opcode.ofNat, Nat.ble, Nat.beq] at chip_cstrs
