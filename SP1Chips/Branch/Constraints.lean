...
@[irreducible] def constraints (Main : Vector (Fin KB) 46) : SP1ConstraintList :=
  let E0 : Fin KB := Main[29] - 1
  let E1 : Fin KB := Main[29] * E0
  let E2 : Fin KB := Main[30] - 1
  let E3 : Fin KB := Main[30] * E2
  let E4 : Fin KB := Main[31] - 1
  let E5 : Fin KB := Main[31] * E4
  let E6 : Fin KB := Main[32] - 1
  let E7 : Fin KB := Main[32] * E6
  let E8 : Fin KB := Main[33] - 1
  let E9 : Fin KB := Main[33] * E8
  let E10 : Fin KB := Main[34] - 1
  let E11 : Fin KB := Main[34] * E10
  let E12 : Fin KB := Main[29] + Main[30]
  let E13 : Fin KB := E12 + Main[31]
  let E14 : Fin KB := E13 + Main[32]
  let E15 : Fin KB := E14 + Main[33]
  let E16 : Fin KB := E15 + Main[34]
  let E17 : Fin KB := E16 - 1
  let E18 : Fin KB := E16 * E17
  let E19 : Fin KB := Main[29] * 27
  let E20 : Fin KB := Main[30] * 28
  let E21 : Fin KB := E19 + E20
  let E22 : Fin KB := Main[31] * 29
  let E23 : Fin KB := E21 + E22
  let E24 : Fin KB := Main[32] * 30
  let E25 : Fin KB := E23 + E24
  let E26 : Fin KB := Main[33] * 31
  let E27 : Fin KB := E25 + E26
  let E28 : Fin KB := Main[34] * 32
  let E29 : Fin KB := E27 + E28
  let E30 : Fin KB := Main[29] * 0
  let E31 : Fin KB := Main[30] * 1
  let E32 : Fin KB := E30 + E31
  let E33 : Fin KB := Main[31] * 4
  let E34 : Fin KB := E32 + E33
  let E35 : Fin KB := Main[32] * 5
  let E36 : Fin KB := E34 + E35
  let E37 : Fin KB := Main[33] * 6
  let E38 : Fin KB := E36 + E37
  let E39 : Fin KB := Main[34] * 7
  let E40 : Fin KB := E38 + E39
  let E41 : Fin KB := Main[29] * 0
  let E42 : Fin KB := Main[30] * 0
  let E43 : Fin KB := E41 + E42
  let E44 : Fin KB := Main[31] * 0
  let E45 : Fin KB := E43 + E44
  let E46 : Fin KB := Main[32] * 0
  let E47 : Fin KB := E45 + E46
  let E48 : Fin KB := Main[33] * 0
  let E49 : Fin KB := E47 + E48
  let E50 : Fin KB := Main[34] * 0
  let E51 : Fin KB := E49 + E50
  let E52 : Fin KB := Main[29] * 99
  let E53 : Fin KB := Main[30] * 99
  let E54 : Fin KB := E52 + E53
  let E55 : Fin KB := Main[31] * 99
  let E56 : Fin KB := E54 + E55
  let E57 : Fin KB := Main[32] * 99
  let E58 : Fin KB := E56 + E57
  let E59 : Fin KB := Main[33] * 99
  let E60 : Fin KB := E58 + E59
  let E61 : Fin KB := Main[34] * 99
  let E62 : Fin KB := E60 + E61
  let E63 : Fin KB := Main[29] * 32
  let E64 : Fin KB := Main[30] * 32
  let E65 : Fin KB := E63 + E64
  let E66 : Fin KB := Main[31] * 32
  let E67 : Fin KB := E65 + E66
  let E68 : Fin KB := Main[32] * 32
  let E69 : Fin KB := E67 + E68
  let E70 : Fin KB := Main[33] * 32
  let E71 : Fin KB := E69 + E70
  let E72 : Fin KB := Main[34] * 32
  ...
  let E76 : Fin KB := Main[31] + Main[32]
  ...
  let E124 : Fin KB := Main[35] * E123
  let E125 : Fin KB := 0 + Main[3]
  let E126 : Fin KB := E125 + 4
  let E127 : Fin KB := E126 - Main[26]
  let E128 : Fin KB := E127 * 2130673921
  let E129 : Fin KB := E16 - Main[35]
  ...
  let E135 : Fin KB := E134 - Main[27]
  let E136 : Fin KB := E135 * 2130673921
  let E137 : Fin KB := E16 - Main[35]
  ...
  let E143 : Fin KB := E142 - Main[28]
  let E144 : Fin KB := E143 * 2130673921
  let E145 : Fin KB := E16 - Main[35]
  ...
  CS0 ++ CS1 ++ CS2 ++ [
    ...
    (.assertZero E148),
    (.assertZero E156),
    (.send (.byte (ByteOpcode.ofNat 6) E157 16 0) E16),
...
def is_real (Main : Vector (Fin KB) 46) :=
  Main[29] = 1 ∨ Main[30] = 1 ∨ Main[31] = 1 ∨ Main[32] = 1 ∨ Main[33] = 1 ∨ Main[34] = 1

lemma single_op (Main : Vector (Fin KB) 46) (cstrs : (constraints Main).allHold) :
    (Main[29] = 1 → Main[30] = 0 ∧ Main[31] = 0 ∧ Main[32] = 0 ∧ Main[33] = 0 ∧ Main[34] = 0) ∧
    (Main[30] = 1 → Main[29] = 0 ∧ Main[31] = 0 ∧ Main[32] = 0 ∧ Main[33] = 0 ∧ Main[34] = 0) ∧
    (Main[31] = 1 → Main[29] = 0 ∧ Main[30] = 0 ∧ Main[32] = 0 ∧ Main[33] = 0 ∧ Main[34] = 0) ∧
    (Main[32] = 1 → Main[29] = 0 ∧ Main[30] = 0 ∧ Main[31] = 0 ∧ Main[33] = 0 ∧ Main[34] = 0) ∧
    (Main[33] = 1 → Main[29] = 0 ∧ Main[30] = 0 ∧ Main[31] = 0 ∧ Main[32] = 0 ∧ Main[34] = 0) ∧
    (Main[34] = 1 → Main[29] = 0 ∧ Main[30] = 0 ∧ Main[31] = 0 ∧ Main[32] = 0 ∧ Main[33] = 0) := by
...
lemma is_trusted_of_constraints (Main : Vector (Fin KB) 46)
