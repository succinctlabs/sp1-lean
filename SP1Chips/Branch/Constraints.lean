...
@[irreducible] def constraints (Main : Vector (Fin KB) 45) : SP1ConstraintList :=
  let E0 : Fin KB := Main[27] - 1
  let E1 : Fin KB := Main[27] * E0
  let E2 : Fin KB := Main[28] - 1
  let E3 : Fin KB := Main[28] * E2
  let E4 : Fin KB := Main[29] - 1
  let E5 : Fin KB := Main[29] * E4
  let E6 : Fin KB := Main[30] - 1
  let E7 : Fin KB := Main[30] * E6
  let E8 : Fin KB := Main[31] - 1
  let E9 : Fin KB := Main[31] * E8
  let E10 : Fin KB := Main[32] - 1
  let E11 : Fin KB := Main[32] * E10
  let E12 : Fin KB := Main[27] + Main[28]
  let E13 : Fin KB := E12 + Main[29]
  let E14 : Fin KB := E13 + Main[30]
  let E15 : Fin KB := E14 + Main[31]
  let E16 : Fin KB := E15 + Main[32]
  let E17 : Fin KB := E16 - 1
  let E18 : Fin KB := E16 * E17
  let E19 : Fin KB := Main[27] * 40
  let E20 : Fin KB := Main[28] * 41
  let E21 : Fin KB := E19 + E20
  let E22 : Fin KB := Main[29] * 42
  let E23 : Fin KB := E21 + E22
  let E24 : Fin KB := Main[30] * 43
  let E25 : Fin KB := E23 + E24
  let E26 : Fin KB := Main[31] * 44
  let E27 : Fin KB := E25 + E26
  let E28 : Fin KB := Main[32] * 45
  let E29 : Fin KB := E27 + E28
  let E30 : Fin KB := Main[27] * 0
  let E31 : Fin KB := Main[28] * 1
  let E32 : Fin KB := E30 + E31
  let E33 : Fin KB := Main[29] * 4
  let E34 : Fin KB := E32 + E33
  let E35 : Fin KB := Main[30] * 5
  let E36 : Fin KB := E34 + E35
  let E37 : Fin KB := Main[31] * 6
  let E38 : Fin KB := E36 + E37
  let E39 : Fin KB := Main[32] * 7
  let E40 : Fin KB := E38 + E39
  let E41 : Fin KB := Main[27] * 0
  let E42 : Fin KB := Main[28] * 0
  let E43 : Fin KB := E41 + E42
  let E44 : Fin KB := Main[29] * 0
  let E45 : Fin KB := E43 + E44
  let E46 : Fin KB := Main[30] * 0
  let E47 : Fin KB := E45 + E46
  let E48 : Fin KB := Main[31] * 0
  let E49 : Fin KB := E47 + E48
  let E50 : Fin KB := Main[32] * 0
  let E51 : Fin KB := E49 + E50
  let E52 : Fin KB := Main[27] * 99
  let E53 : Fin KB := Main[28] * 99
  let E54 : Fin KB := E52 + E53
  let E55 : Fin KB := Main[29] * 99
  let E56 : Fin KB := E54 + E55
  let E57 : Fin KB := Main[30] * 99
  let E58 : Fin KB := E56 + E57
  let E59 : Fin KB := Main[31] * 99
  let E60 : Fin KB := E58 + E59
  let E61 : Fin KB := Main[32] * 99
  let E62 : Fin KB := E60 + E61
  let E63 : Fin KB := Main[27] * 32
  let E64 : Fin KB := Main[28] * 32
  let E65 : Fin KB := E63 + E64
  let E66 : Fin KB := Main[29] * 32
  let E67 : Fin KB := E65 + E66
  let E68 : Fin KB := Main[30] * 32
  let E69 : Fin KB := E67 + E68
  let E70 : Fin KB := Main[31] * 32
  let E71 : Fin KB := E69 + E70
  let E72 : Fin KB := Main[32] * 32
  let E73 : Fin KB := E71 + E72
  let CS0 : SP1ConstraintList := CPUState.constraints { clk_high := Main[0], clk_16_24 := Main[1], clk_0_16 := Main[2], pc := #v[Main[3], Main[4], Main[5]] } #v[Main[25], Main[25], Main[26]] 8 E16
  ...
  let E76 : Fin KB := Main[29] + Main[30]
  let CS2 : SP1ConstraintList := LtOperationSigned.constraints #v[Main[7], Main[8], Main[9], Main[10]] #v[Main[15], Main[16], Main[17], Main[18]] { result := { u16_compare_operation := { bit := Main[34] }, u16_flags := #v[Main[35], Main[36], Main[37], Main[38]], not_eq_inv := Main[39], comparison_limbs := #v[Main[40], Main[41]] }, b_msb := { msb := Main[42] }, c_msb := { msb := Main[43] } } E76 E16
  let E77 : Fin KB := Main[35] + Main[36]
  let E78 : Fin KB := E77 + Main[37]
  let E79 : Fin KB := E78 + Main[38]
  let E80 : Fin KB := 1 - E79
  let E81 : Fin KB := Main[27] * E80
  let E82 : Fin KB := 0 + E81
  let E83 : Fin KB := 1 - E80
  let E84 : Fin KB := Main[28] * E83
  let E85 : Fin KB := E82 + E84
  let E86 : Fin KB := Main[30] + Main[32]
  let E87 : Fin KB := 1 - Main[34]
  let E88 : Fin KB := E86 * E87
  let E89 : Fin KB := E85 + E88
  let E90 : Fin KB := Main[29] + Main[31]
  let E91 : Fin KB := E90 * Main[34]
  let E92 : Fin KB := E89 + E91
  let E93 : Fin KB := Main[33] - 1
  let E94 : Fin KB := Main[33] * E93
  let E95 : Fin KB := Main[33] - E92
  ...
  let E135 : Fin KB := E134 - Main[25]
  let E136 : Fin KB := E135 * 2130673921
  let E137 : Fin KB := E16 - Main[33]
  ...
  let E143 : Fin KB := E142 - Main[26]
  let E144 : Fin KB := E143 * 2130673921
  let E145 : Fin KB := E16 - Main[33]
