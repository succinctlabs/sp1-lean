...
theorem correct_bltu
  ...
  := by
    ...
    clear cpu_cstrs
    simp [ITypeReaderImmutable.constraints, SP1Constraint.toProp, h_is_bltu, h_28, h_29, h_30, h_31, h_33, Opcode.ofNat, Nat.ble, Nat.beq] at reader_cstrs
    ...
    simp [SP1ConstraintList.initialState, constraints, SP1Constraint.toStateProp, List.Forall, CPUState.constraints, ITypeReaderImmutable.constraints, LtOperationSigned.constraints, LtOperationUnsigned.constraints, U16MSBOperation.constraints, U16CompareOperation.constraints, h_is_bltu, h_28, h_29, h_30, h_31, h_33, Opcode.ofNat, Nat.ble, Nat.beq] at state_cstrs
    ...
    · rename_i h_ltu
      ...
      simp [h_is_bltu, h_neq, h_is_lt, h_is_neq, h_28, h_29, h_30, h_31, h_33, Opcode.ofNat, Nat.ble, Nat.beq] at chip_cstrs
    ...
    · rename_i h_eq
      ...
      have h_is_eq : (Main[36] + Main[37] + Main[38] + Main[39]) = 0 :=
        by
          clear * - spec_lt
          aesop
      have h_is_ge : Main[35] = 0 := by clear * - spec_lt; aesop
