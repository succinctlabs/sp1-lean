...
theorem correct_bgeu
  ...
  := by
    ...
    · rename_i h_eq
      ...
      simp [h_is_bgeu, h_eq, h_is_lt, h_is_eq, h_28, h_29, h_30, h_31, h_33, h_is_real, h_opcode, Opcode.ofNat, Nat.ble, Nat.beq] at chip_cstrs
    ...
    simp [h_is_bgeu, h_neq, h_is_lt, h_is_eq, h_28, h_29, h_30, h_31, h_33, h_is_real, h_opcode, Opcode.ofNat, Nat.ble, Nat.beq] at chip_cstrs
    simp [sub_eq_zero] at chip_cstrs
    have h_is_branching : Main[34] = 1 := by simp_all only
    simp [h_is_branching] at chip_cstrs
