...
@[irreducible] def constraints (Main : Vector (Fin KB) 35) : SP1ConstraintList (Fin KB) :=
  let E0 : Fin KB := Main[25] - 1
  let E1 : Fin KB := Main[25] * E0
  let CS0 : SP1ConstraintList (Fin KB) := AddOperation.constraints #v[Main[15], Main[16], Main[17], Main[18]] #v[Main[21], Main[22], Main[23], Main[24]] { value := #v[Main[26], Main[27], Main[28], Main[29]] } Main[25]
