...
@[irreducible] def constraints (Main : Vector (Fin KB) 65) : SP1ConstraintList (Fin KB) :=
  ...
  let CS0 : SP1ConstraintList (Fin KB) := U16MSBOperation.constraints Main[33] { msb := Main[61] } Main[63]
