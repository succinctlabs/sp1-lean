...
@[irreducible] def constraints (Main : Vector (Fin KB) 50) : SP1ConstraintList :=
  ...
  let E2 : Fin KB := 19 * Main[42]
  let E3 : Fin KB := 22 * Main[43]
  let E4 : Fin KB := E2 + E3
  let E5 : Fin KB := 20 * Main[44]
  let E6 : Fin KB := E4 + E5
  let E7 : Fin KB := 23 * Main[45]
  let E8 : Fin KB := E6 + E7
  let E9 : Fin KB := 21 * Main[46]
  let E10 : Fin KB := E8 + E9
  let E11 : Fin KB := 44 * Main[47]
  let E12 : Fin KB := E10 + E11
  let E13 : Fin KB := 45 * Main[48]
  let E14 : Fin KB := E12 + E13
  let E15 : Fin KB := Main[42] * 0
  let E16 : Fin KB := Main[43] * 4
  let E17 : Fin KB := E15 + E16
  let E18 : Fin KB := Main[44] * 1
  let E19 : Fin KB := E17 + E18
  let E20 : Fin KB := Main[45] * 5
  let E21 : Fin KB := E19 + E20
  let E22 : Fin KB := Main[46] * 2
  let E23 : Fin KB := E21 + E22
  let E24 : Fin KB := Main[47] * 6
  let E25 : Fin KB := E23 + E24
  let E26 : Fin KB := Main[48] * 3
  let E27 : Fin KB := E25 + E26
  let E28 : Fin KB := Main[42] * 0
  let E29 : Fin KB := Main[43] * 0
  let E30 : Fin KB := E28 + E29
  let E31 : Fin KB := Main[44] * 0
  let E32 : Fin KB := E30 + E31
  let E33 : Fin KB := Main[45] * 0
  let E34 : Fin KB := E32 + E33
  let E35 : Fin KB := Main[46] * 0
  let E36 : Fin KB := E34 + E35
  let E37 : Fin KB := Main[47] * 0
  let E38 : Fin KB := E36 + E37
  let E39 : Fin KB := Main[48] * 0
  let E40 : Fin KB := E38 + E39
  let E41 : Fin KB := Main[42] * 3
  let E42 : Fin KB := Main[43] * 3
  let E43 : Fin KB := E41 + E42
  let E44 : Fin KB := Main[44] * 3
  let E45 : Fin KB := E43 + E44
  let E46 : Fin KB := Main[45] * 3
  let E47 : Fin KB := E45 + E46
  let E48 : Fin KB := Main[46] * 3
  let E49 : Fin KB := E47 + E48
  let E50 : Fin KB := Main[47] * 3
  let E51 : Fin KB := E49 + E50
  let E52 : Fin KB := Main[48] * 3
  let E53 : Fin KB := E51 + E52
  let E54 : Fin KB := Main[42] * 4
  let E55 : Fin KB := Main[43] * 4
  let E56 : Fin KB := E54 + E55
  let E57 : Fin KB := Main[44] * 4
  let E58 : Fin KB := E56 + E57
  let E59 : Fin KB := Main[45] * 4
  let E60 : Fin KB := E58 + E59
  let E61 : Fin KB := Main[46] * 4
  let E62 : Fin KB := E60 + E61
  let E63 : Fin KB := Main[47] * 4
  let E64 : Fin KB := E62 + E63
  let E65 : Fin KB := Main[48] * 4
  let E66 : Fin KB := E64 + E65
  let E67 : Fin KB := Main[42] + Main[43]
  let E68 : Fin KB := E67 + Main[44]
  let E69 : Fin KB := E68 + Main[45]
  let E70 : Fin KB := E69 + Main[46]
  let E71 : Fin KB := E70 + Main[47]
  let E72 : Fin KB := E71 + Main[48]
  let E73 : Fin KB := Main[42] - 1
  let E74 : Fin KB := Main[42] * E73
  let E75 : Fin KB := Main[43] - 1
  let E76 : Fin KB := Main[43] * E75
  let E77 : Fin KB := Main[44] - 1
  let E78 : Fin KB := Main[44] * E77
  let E79 : Fin KB := Main[45] - 1
  let E80 : Fin KB := Main[45] * E79
  let E81 : Fin KB := Main[46] - 1
  let E82 : Fin KB := Main[46] * E81
  let E83 : Fin KB := Main[47] - 1
  let E84 : Fin KB := Main[47] * E83
  let E85 : Fin KB := Main[48] - 1
  let E86 : Fin KB := Main[48] * E85
  ...
  let E92 : Fin KB := Main[48] * Main[41]
  let E93 : Fin KB := Main[46] + Main[47]
  let E94 : Fin KB := E93 + Main[48]
  let E95 : Fin KB := E94 * Main[40]
  let E96 : Fin KB := Main[44] + Main[45]
  let E97 : Fin KB := E96 + Main[46]
  let E98 : Fin KB := E97 + Main[47]
  let E99 : Fin KB := E98 + Main[48]
  let E100 : Fin KB := E99 * Main[39]
  let E101 : Fin KB := E1 + 1
  let E102 : Fin KB := E72 - 1
  let E103 : Fin KB := E72 * E102
  let E104 : Fin KB := Main[36] - 1
  let E105 : Fin KB := Main[36] * E104
  let E106 : Fin KB := E72 * E105
  let E107 : Fin KB := Main[0] - Main[34]
  let E108 : Fin KB := Main[36] * E107
  let E109 : Fin KB := E72 * E108
  let E110 : Fin KB := Main[36] * Main[35]
  let E111 : Fin KB := 1 - Main[36]
  let E112 : Fin KB := E111 * Main[34]
  let E113 : Fin KB := E110 + E112
  let E114 : Fin KB := Main[36] * E101
  let E115 : Fin KB := 1 - Main[36]
  let E116 : Fin KB := E115 * Main[0]
  let E117 : Fin KB := E114 + E116
  let E118 : Fin KB := E117 - E113
  let E119 : Fin KB := E118 - 1
  let E120 : Fin KB := Main[38] * 65536
  ...
  let E128 : Fin KB := E72 * E127
  let E129 : Fin KB := Main[3] + 4
