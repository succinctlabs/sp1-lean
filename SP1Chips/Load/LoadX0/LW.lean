...
def sp1_op_a : BitVec 5 :=
  by
    ...
    show Main[6] < 32
    have ⟨h_lb, h_lbu, h_lh, h_lhu, h_lw, h_lwu, h_ld⟩ := (h_exactly_one Main cstrs).2.2.2.2.1 h_is_lw
...
def sp1_lw : SailM ExecutionResult := do
...
theorem correct_x0
  ...
  := by
    ...
    simp [constraints, AddressOperation.constraints, SP1Constraint.toProp, List.Forall, h_is_lw, h_lb, h_lbu, h_lh, h_lhu, h_lw, h_lwu, h_ld, Opcode.ofNat, ByteOpcode.ofNat, Nat.beq, Nat.ble, sub_eq_zero] at cstrs
