...
def sp1_lhu : SailM ExecutionResult := do
...
theorem correct_x0
  ...
  := by
    ...
    simp [constraints, AddressOperation.constraints, SP1Constraint.toProp, List.Forall, h_is_lhu, h_lb, h_lbu, h_lh, h_lhu, h_lw, h_lwu, h_ld, Opcode.ofNat, ByteOpcode.ofNat, Nat.beq, Nat.ble, sub_eq_zero] at cstrs
