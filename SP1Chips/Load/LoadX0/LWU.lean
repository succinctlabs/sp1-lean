...
def sp1_op_a : BitVec 5 :=
  by
    ...
    show Main[6] < 32
    have ⟨h_lb, h_lbu, h_lh, h_lhu, h_lw, h_lwu, h_ld⟩ := (h_exactly_one Main cstrs).2.2.2.2.2.1 h_is_lwu
...
def sp1_lwu : SailM ExecutionResult := do
...
theorem correct_x0
  ...
  := by
    ...
    simp [constraints, AddressOperation.constraints, SP1Constraint.toProp, List.Forall, h_is_lwu, h_lb, h_lbu, h_lh, h_lhu, h_lw, h_lwu, h_ld, Opcode.ofNat, ByteOpcode.ofNat, Nat.beq, Nat.ble, sub_eq_zero] at cstrs
    ...
    simp [not_and_or.mpr h_over_addr, Word.toNat, h_addr_no_shift0, h_addr_no_shift1] at h_read_mem
    ...
    cases h_addr_shift2  <;> rename_i h_shift2
    <;> simp [h_shift2] at chip_cstrs h_read_limb0 h_read_limb1 h_read_limb2 h_read_limb3 addr_cstr1
    <;> [
      ( skip

        obtain ⟨h_read_mem0, h_read_mem1, h_read_mem2, h_read_mem3⟩ :
      ...
      ( skip
        ...
        obtain ⟨h_read_mem0, h_read_mem1, h_read_mem2, h_read_mem3⟩ :
          ...
          := by
            simp only [op_c, sp1_imm, sign_extend, Sail.BitVec.signExtend]
            rw [←h_op_c_is_signExtend, ←h_addr_add_spec]
            clear * - h_read_limb0 h_read_limb1 h_read_limb2 h_read_limb3 h_addr_limb0_ge4
            simp [-BitVec.toNat_ofNat, Word.toBitVec64, Word.toNat]
            rw [←BitVec.ofNatLT_eq_ofNat (by omega)]
            simp [BitVec.ofNatLT_toNat]
