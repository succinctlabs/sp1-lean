...
def constraints (Main : Vector (Fin BB) 46) : SP1ConstraintList :=
  ...
  let E3 : Fin BB := 23 * Main[44]
  let E4 : Fin BB := E2 + E3
  let E5 : Fin BB := Main[43] * 1
  let E6 : Fin BB := Main[44] * 5
  let E7 : Fin BB := E5 + E6
  ...
  let E50 : Fin BB := Public Arg [151] * E17
  let E51 : Fin BB := Main[45] - E50
  let E52 : Fin BB := E1 + 1
  let E53 : Fin BB := Main[39] - 1
  let E54 : Fin BB := Main[40] - 1
  let E55 : Fin BB := Main[41] - Main[30]
  let E56 : Fin BB := E54 * E55
  let E57 : Fin BB := E53 * E56
  let E58 : Fin BB := Main[40] - 1
  let E59 : Fin BB := Main[41] - Main[31]
  let E60 : Fin BB := E58 * E59
  let E61 : Fin BB := Main[39] * E60
  let E62 : Fin BB := Main[39] - 1
  let E63 : Fin BB := Main[41] - Main[32]
  let E64 : Fin BB := Main[40] * E63
  let E65 : Fin BB := E62 * E64
  let E66 : Fin BB := Main[41] - Main[33]
  let E67 : Fin BB := Main[40] * E66
  let E68 : Fin BB := Main[39] * E67
  let E69 : Fin BB := Main[44] * Main[42]
  ...
  let E71 : Fin BB := 65535 * Main[42]
  let E72 : Fin BB := 65535 * Main[42]
  let E73 : Fin BB := 65535 * Main[42]
