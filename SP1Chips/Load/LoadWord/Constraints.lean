...
def constraints (Main : Vector (Fin BB) 44) : SP1ConstraintList :=
  ...
  let ⟨⟨⟨[E21, E22, E23]⟩, _⟩, CS0⟩ := AddressOperation.constraints #v[Main[15], Main[16], Main[17], Main[18]] #v[Main[21], Main[22], Main[23], Main[24]] 0 0 Main[38] E14 { addr_word_operation := { value := #v[Main[25], Main[26], Main[27]] }, top_two_limb_inv := Main[28] }
