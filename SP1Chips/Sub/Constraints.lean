...
@[irreducible] def constraints (Main : Vector (Fin BB) 34) : SP1ConstraintList :=
  let E0 : Fin BB := Main[33] - 1
  let E1 : Fin BB := Main[33] * E0
  let CS0 : SP1ConstraintList := SubOperation.constraints #v[Main[15], Main[16], Main[17], Main[18]] #v[Main[22], Main[23], Main[24], Main[25]] { value := #v[Main[29], Main[30], Main[31], Main[32]] } Main[33]
