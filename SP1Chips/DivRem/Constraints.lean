...
lemma spec.rem
  ...
  (eq_rcm : remainder_check_multiplicity = 1 - is_c_0)
  (eq_arlt : 1 - is_c_0 = 0 ∨ arlt = 1)
  (u16_q0 : q0.val < 65536)
  (u16_q1 : q1.val < 65536)
  (u16_q2 : q2.val < 65536)
  (u16_q3 : q3.val < 65536)
  ...
  is_rem = 1 →
    Word.toInt #v[a0, a1, a2, a3] = Int.tmod (Word.toInt #v[b0, b1, b2, b3]) (Word.toInt #v[c0, c1, c2, c3]) := by
  intro h_rem; simp [h_rem] at *
  obtain ⟨ hz0, hz1, hz2, hz3, hz4, hz5, hz6 ⟩ := sop3; simp [hz0, hz1, hz2, hz3, hz4, hz5, hz6] at *
  simp [eq_is_word, eq_lb0, eq_lb1, eq_lc0, eq_lc1, eq_qbc0, eq_qbc1, eq_qbc2, eq_qbc3, eq_rbc0, eq_rbc1, eq_rbc2, eq_rbc3, eq_r_a0, eq_r_a1, eq_r_a2, eq_r_a3] at *



end constraints_as_hypotheses
