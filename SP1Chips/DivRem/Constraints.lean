...
def constraints (Main : Vector (Fin BB) 251) : SP1ConstraintList :=
  ...
  let E3 : Fin BB := Main[209] + Main[210]
  let E4 : Fin BB := 1 - E2
  let E5 : Fin BB := Main[249] * E4
  let E6 : Fin BB := Main[244] - E5
  let E7 : Fin BB := Main[205] + Main[207]
  let E8 : Fin BB := E7 + Main[209]
  let E9 : Fin BB := E8 + Main[210]
  let E10 : Fin BB := Main[237] * E9
  let E11 : Fin BB := E10 - Main[241]
  let E12 : Fin BB := Main[238] * E9
  let E13 : Fin BB := E12 - Main[245]
  let E14 : Fin BB := Main[239] * E9
  let E15 : Fin BB := E14 - Main[246]
  ...
  let E69 : Fin BB := Main[205] + Main[207]
  let E70 : Fin BB := E69 + Main[209]
  let E71 : Fin BB := E70 + Main[210]
  let E72 : Fin BB := Main[225] * Main[236]
  let E73 : Fin BB := E72 * E71
  let E74 : Fin BB := Main[214] - E73
  let E75 : Fin BB := Main[245] * 65535
  let E76 : Fin BB := Main[72] + Main[52]
  let E77 : Fin BB := Main[186] * 65536
  let E78 : Fin BB := E76 - E77
  let E79 : Fin BB := Main[73] + Main[53]
  let E80 : Fin BB := Main[187] * 65536
  let E81 : Fin BB := E79 - E80
  let E82 : Fin BB := E81 + Main[186]
  let E83 : Fin BB := Main[74] + Main[54]
  let E84 : Fin BB := Main[188] * 65536
  let E85 : Fin BB := E83 - E84
  let E86 : Fin BB := E85 + Main[187]
  let E87 : Fin BB := Main[75] + Main[55]
  let E88 : Fin BB := Main[189] * 65536
  let E89 : Fin BB := E87 - E88
  let E90 : Fin BB := E89 + Main[188]
  let E91 : Fin BB := Main[76] + E75
  let E92 : Fin BB := Main[190] * 65536
  let E93 : Fin BB := E91 - E92
  let E94 : Fin BB := E93 + Main[189]
  let E95 : Fin BB := Main[77] + E75
  let E96 : Fin BB := Main[191] * 65536
  let E97 : Fin BB := E95 - E96
  let E98 : Fin BB := E97 + Main[190]
  let E99 : Fin BB := Main[78] + E75
  let E100 : Fin BB := Main[192] * 65536
  let E101 : Fin BB := E99 - E100
  let E102 : Fin BB := E101 + Main[191]
  let E103 : Fin BB := Main[79] + E75
  let E104 : Fin BB := Main[193] * 65536
  let E105 : Fin BB := E103 - E104
  let E106 : Fin BB := E105 + Main[192]
  ...
  let E113 : Fin BB := Main[242] * E112
  let E114 : Fin BB := E2 * E113
  let E115 : Fin BB := E86 - 0
  let E116 : Fin BB := Main[243] * E115
  ...
  let E125 : Fin BB := Main[242] * E124
  let E126 : Fin BB := E2 * E125
  let E127 : Fin BB := E90 - 0
  let E128 : Fin BB := Main[243] * E127
  let E129 : Fin BB := E2 * E128
  let E130 : Fin BB := E90 - 65535
  let E131 : Fin BB := Main[214] * E130
  let E132 : Fin BB := E2 * E131
  let E133 : Fin BB := E94 - 65535
  let E134 : Fin BB := Main[242] * E133
  let E135 : Fin BB := Main[243] * E94
  let E136 : Fin BB := 1 - E2
  let E137 : Fin BB := Main[214] * E136
  let E138 : Fin BB := E137 * E94
  let E139 : Fin BB := E98 - 65535
  let E140 : Fin BB := Main[242] * E139
  let E141 : Fin BB := Main[243] * E98
  let E142 : Fin BB := 1 - E2
  let E143 : Fin BB := Main[214] * E142
  let E144 : Fin BB := E143 * E98
  let E145 : Fin BB := E102 - 65535
  let E146 : Fin BB := Main[242] * E145
  let E147 : Fin BB := Main[243] * E102
  let E148 : Fin BB := 1 - E2
  let E149 : Fin BB := Main[214] * E148
  let E150 : Fin BB := E149 * E102
  let E151 : Fin BB := E106 - 65535
  let E152 : Fin BB := Main[242] * E151
  let E153 : Fin BB := Main[243] * E106
  let E154 : Fin BB := 1 - E2
  let E155 : Fin BB := Main[214] * E154
  ...
  let E167 : Fin BB := Main[245] * 65535
  ...
  let E173 : Fin BB := Main[245] * 65535
  ...
  let E179 : Fin BB := Main[206] + Main[205]
  let E180 : Fin BB := E179 + Main[209]
  let E181 : Fin BB := E180 + Main[211]
  let E182 : Fin BB := Main[44] - Main[32]
  let E183 : Fin BB := E181 * E182
  let E184 : Fin BB := Main[208] + Main[207]
  let E185 : Fin BB := E184 + Main[210]
  let E186 : Fin BB := E185 + Main[212]
  let E187 : Fin BB := Main[56] - Main[32]
  let E188 : Fin BB := E186 * E187
  let E189 : Fin BB := Main[206] + Main[205]
  let E190 : Fin BB := E189 + Main[209]
  let E191 : Fin BB := E190 + Main[211]
  let E192 : Fin BB := Main[45] - Main[33]
  let E193 : Fin BB := E191 * E192
  let E194 : Fin BB := Main[208] + Main[207]
  let E195 : Fin BB := E194 + Main[210]
  let E196 : Fin BB := E195 + Main[212]
  let E197 : Fin BB := Main[57] - Main[33]
  let E198 : Fin BB := E196 * E197
  let E199 : Fin BB := Main[206] + Main[205]
  let E200 : Fin BB := E199 + Main[209]
  let E201 : Fin BB := E200 + Main[211]
  let E202 : Fin BB := Main[46] - Main[34]
  let E203 : Fin BB := E201 * E202
  let E204 : Fin BB := Main[208] + Main[207]
  let E205 : Fin BB := E204 + Main[210]
  let E206 : Fin BB := E205 + Main[212]
  let E207 : Fin BB := Main[58] - Main[34]
  let E208 : Fin BB := E206 * E207
  let E209 : Fin BB := Main[206] + Main[205]
  let E210 : Fin BB := E209 + Main[209]
  let E211 : Fin BB := E210 + Main[211]
  let E212 : Fin BB := Main[47] - Main[35]
  let E213 : Fin BB := E211 * E212
  let E214 : Fin BB := Main[208] + Main[207]
  let E215 : Fin BB := E214 + Main[210]
  let E216 : Fin BB := E215 + Main[212]
  let E217 : Fin BB := Main[59] - Main[35]
  let E218 : Fin BB := E216 * E217
  let E219 : Fin BB := Main[240] * 65535
  let E220 : Fin BB := E219 - Main[46]
  let E221 : Fin BB := E2 * E220
  let E222 : Fin BB := Main[238] * 65535
  let E223 : Fin BB := E222 - Main[58]
  let E224 : Fin BB := E2 * E223
  let E225 : Fin BB := Main[240] * 65535
  let E226 : Fin BB := E225 - Main[47]
  let E227 : Fin BB := E2 * E226
  let E228 : Fin BB := Main[238] * 65535
  ...
  let E235 : Fin BB := Main[241] - 1
  let E236 : Fin BB := Main[245] * E235
  let E237 : Fin BB := 1 - Main[245]
  let E238 : Fin BB := E237 * Main[241]
  ...
  let E272 : Fin BB := 0 - Main[170]
  let E273 : Fin BB := Main[247] * E272
  let E274 : Fin BB := 0 - Main[171]
  let E275 : Fin BB := Main[247] * E274
  let E276 : Fin BB := 0 - Main[172]
  let E277 : Fin BB := Main[247] * E276
  let E278 : Fin BB := 0 - Main[173]
  let E279 : Fin BB := Main[247] * E278
  let CS8 : SP1ConstraintList := AddOperation.constraints #v[Main[56], Main[57], Main[58], Main[59]] #v[Main[60], Main[61], Main[62], Main[63]] { value := #v[Main[174], Main[175], Main[176], Main[177]] } Main[248]
  let E280 : Fin BB := 0 - Main[174]
  let E281 : Fin BB := Main[248] * E280
  let E282 : Fin BB := 0 - Main[175]
  let E283 : Fin BB := Main[248] * E282
  let E284 : Fin BB := 0 - Main[176]
  let E285 : Fin BB := Main[248] * E284
  let E286 : Fin BB := 0 - Main[177]
  let E287 : Fin BB := Main[248] * E286
  let E288 : Fin BB := Main[246] * Main[249]
  let E289 : Fin BB := Main[247] - E288
  let E290 : Fin BB := Main[245] * Main[249]
  let E291 : Fin BB := Main[248] - E290
  let E292 : Fin BB := Main[204] * 1
  let E293 : Fin BB := 1 - Main[204]
  let E294 : Fin BB := E293 * Main[64]
  let E295 : Fin BB := E292 + E294
  let E296 : Fin BB := 1 - Main[204]
  let E297 : Fin BB := E296 * Main[65]
  let E298 : Fin BB := 1 - Main[204]
  let E299 : Fin BB := E298 * Main[66]
  let E300 : Fin BB := 1 - Main[204]
  ...
  let E306 : Fin BB := 1 - Main[204]
  let E307 : Fin BB := E306 * Main[249]
  let E308 : Fin BB := E307 - Main[250]
  ...
  let E309 : Fin BB := 1 - Main[178]
  let E310 : Fin BB := Main[250] * E309
  ...
  let E311 : Fin BB := Main[186] - 1
  let E312 : Fin BB := Main[186] * E311
  let E313 : Fin BB := Main[187] - 1
  let E314 : Fin BB := Main[187] * E313
  let E315 : Fin BB := Main[188] - 1
  let E316 : Fin BB := Main[188] * E315
  let E317 : Fin BB := Main[189] - 1
  let E318 : Fin BB := Main[189] * E317
  let E319 : Fin BB := Main[190] - 1
  let E320 : Fin BB := Main[190] * E319
  let E321 : Fin BB := Main[191] - 1
  let E322 : Fin BB := Main[191] * E321
  let E323 : Fin BB := Main[192] - 1
  let E324 : Fin BB := Main[192] * E323
  let E325 : Fin BB := Main[193] - 1
  let E326 : Fin BB := Main[193] * E325
  let E327 : Fin BB := Main[205] - 1
  let E328 : Fin BB := Main[205] * E327
  let E329 : Fin BB := Main[206] - 1
  let E330 : Fin BB := Main[206] * E329
  let E331 : Fin BB := Main[207] - 1
  let E332 : Fin BB := Main[207] * E331
  let E333 : Fin BB := Main[208] - 1
  let E334 : Fin BB := Main[208] * E333
  let E335 : Fin BB := Main[209] - 1
  let E336 : Fin BB := Main[209] * E335
  let E337 : Fin BB := Main[210] - 1
  let E338 : Fin BB := Main[210] * E337
  let E339 : Fin BB := Main[211] - 1
  let E340 : Fin BB := Main[211] * E339
  let E341 : Fin BB := Main[212] - 1
  let E342 : Fin BB := Main[212] * E341
  let E343 : Fin BB := Main[214] - 1
  let E344 : Fin BB := Main[214] * E343
  let E345 : Fin BB := Main[244] - 1
  let E346 : Fin BB := Main[244] * E345
  let E347 : Fin BB := Main[241] - 1
  let E348 : Fin BB := Main[241] * E347
  let E349 : Fin BB := Main[242] - 1
  let E350 : Fin BB := Main[242] * E349
  let E351 : Fin BB := Main[243] - 1
  let E352 : Fin BB := Main[243] * E351
  let E353 : Fin BB := Main[245] - 1
  let E354 : Fin BB := Main[245] * E353
  let E355 : Fin BB := Main[246] - 1
  let E356 : Fin BB := Main[246] * E355
  let E357 : Fin BB := Main[249] - 1
  let E358 : Fin BB := Main[249] * E357
  let E359 : Fin BB := Main[247] - 1
  let E360 : Fin BB := Main[247] * E359
  let E361 : Fin BB := Main[248] - 1
  let E362 : Fin BB := Main[248] * E361
  let E363 : Fin BB := Main[206] + Main[208]
  let E364 : Fin BB := E363 + Main[205]
  let E365 : Fin BB := E364 + Main[207]
  let E366 : Fin BB := E365 + Main[209]
  let E367 : Fin BB := E366 + Main[210]
  let E368 : Fin BB := E367 + Main[211]
  let E369 : Fin BB := E368 + Main[212]
  let E370 : Fin BB := 1 - E369
  let E371 : Fin BB := Main[206] * 16
  let E372 : Fin BB := Main[208] * 18
  let E373 : Fin BB := E371 + E372
  let E374 : Fin BB := Main[205] * 15
  let E375 : Fin BB := E373 + E374
  let E376 : Fin BB := Main[207] * 17
  let E377 : Fin BB := E375 + E376
  let E378 : Fin BB := Main[209] * 48
  let E379 : Fin BB := E377 + E378
  let E380 : Fin BB := Main[210] * 50
  let E381 : Fin BB := E379 + E380
  let E382 : Fin BB := Main[211] * 49
  let E383 : Fin BB := E381 + E382
  let E384 : Fin BB := Main[212] * 51
  let E385 : Fin BB := E383 + E384
  let E386 : Fin BB := Main[206] * 5
  let E387 : Fin BB := Main[208] * 7
  let E388 : Fin BB := E386 + E387
  let E389 : Fin BB := Main[205] * 4
  let E390 : Fin BB := E388 + E389
  let E391 : Fin BB := Main[207] * 6
  let E392 : Fin BB := E390 + E391
  let E393 : Fin BB := Main[209] * 4
  let E394 : Fin BB := E392 + E393
  let E395 : Fin BB := Main[210] * 6
  let E396 : Fin BB := E394 + E395
  let E397 : Fin BB := Main[211] * 5
  let E398 : Fin BB := E396 + E397
  let E399 : Fin BB := Main[212] * 7
  let E400 : Fin BB := E398 + E399
  let E401 : Fin BB := Main[206] * 1
  let E402 : Fin BB := Main[208] * 1
  let E403 : Fin BB := E401 + E402
  let E404 : Fin BB := Main[205] * 1
  let E405 : Fin BB := E403 + E404
  let E406 : Fin BB := Main[207] * 1
  let E407 : Fin BB := E405 + E406
  let E408 : Fin BB := Main[209] * 1
  let E409 : Fin BB := E407 + E408
  let E410 : Fin BB := Main[210] * 1
  let E411 : Fin BB := E409 + E410
  let E412 : Fin BB := Main[211] * 1
  let E413 : Fin BB := E411 + E412
  let E414 : Fin BB := Main[212] * 1
  let E415 : Fin BB := E413 + E414
  let E416 : Fin BB := Main[209] * 27
  let E417 : Fin BB := Main[210] * 27
  let E418 : Fin BB := E416 + E417
  let E419 : Fin BB := Main[211] * 27
  let E420 : Fin BB := E418 + E419
  let E421 : Fin BB := Main[212] * 27
  let E422 : Fin BB := E420 + E421
  let E423 : Fin BB := Main[206] * 51
  let E424 : Fin BB := Main[208] * 51
  let E425 : Fin BB := E423 + E424
  let E426 : Fin BB := Main[205] * 51
  let E427 : Fin BB := E425 + E426
  let E428 : Fin BB := Main[207] * 51
  let E429 : Fin BB := E427 + E428
  let E430 : Fin BB := Main[209] * 59
  let E431 : Fin BB := E429 + E430
  let E432 : Fin BB := Main[210] * 59
  let E433 : Fin BB := E431 + E432
  let E434 : Fin BB := Main[211] * 59
  let E435 : Fin BB := E433 + E434
  let E436 : Fin BB := Main[212] * 59
  let E437 : Fin BB := E435 + E436
  let E438 : Fin BB := Main[31] * E422
  let E439 : Fin BB := 1 - Main[31]
  let E440 : Fin BB := E439 * E437
  let E441 : Fin BB := E438 + E440
  let E442 : Fin BB := Main[213] - E441
  let E443 : Fin BB := Main[249] * E442
  let E444 : Fin BB := Main[3] + 4
  let CS17 : SP1ConstraintList := CPUState.constraints { clk_high := Main[0], clk_16_24 := Main[1], clk_0_16 := Main[2], pc := #v[Main[3], Main[4], Main[5]] } #v[E444, Main[4], Main[5]] 8 Main[249]
  let E445 : Fin BB := Main[1] * 65536
  let E446 : Fin BB := Main[2] + E445
  let CS18 : SP1ConstraintList := ALUTypeReader.constraints Main[0] E446 #v[Main[3], Main[4], Main[5]] E385 #v[Main[213], E400, E415] #v[Main[32], Main[33], Main[34], Main[35]] { op_a := Main[6], op_a_memory := { prev_value := #v[Main[7], Main[8], Main[9], Main[10]], access_timestamp := { prev_low := Main[11], diff_low_limb := Main[12] } }, op_a_0 := Main[13], op_b := Main[14], op_b_memory := { prev_value := #v[Main[15], Main[16], Main[17], Main[18]], access_timestamp := { prev_low := Main[19], diff_low_limb := Main[20] } }, op_c := #v[Main[21], Main[22], Main[23], Main[24]], op_c_memory := { prev_value := #v[Main[25], Main[26], Main[27], Main[28]], access_timestamp := { prev_low := Main[29], diff_low_limb := Main[30] } }, imm_c := Main[31] } Main[249]
