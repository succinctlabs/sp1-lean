...
/-- Type quantifiers: k_ex375828# : Bool, level : Nat, k_ex375826# : Bool, k_ex375825# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex375873# : Bool, k_ex375872# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex375894# : Bool, k_ex375893# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex375930# : Bool, k_ex375929# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
