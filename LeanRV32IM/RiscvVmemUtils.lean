...
/-- Type quantifiers: k_ex69532# : Bool, k_ex69531# : Bool, k_ex69530# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex69583# : Bool, k_ex69582# : Bool, k_ex69581# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex69618# : Bool, k_ex69617# : Bool, k_ex69616# : Bool, width : Nat, is_mem_width(width) -/
